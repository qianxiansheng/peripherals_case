...
--define_symbol ll_hint_on_ce_len=0x0000cf61
--define_symbol ll_legacy_adv_set_interval=0x0000cf99
--define_symbol ll_malloc=0x0000cfa9
--define_symbol ll_query_timing_info=0x0000d0e1
--define_symbol ll_scan_set_fixed_channel=0x0000d185
--define_symbol ll_set_adv_access_address=0x0000d299
--define_symbol ll_set_adv_coded_scheme=0x0000d2a5
--define_symbol ll_set_conn_coded_scheme=0x0000d2d5
--define_symbol ll_set_conn_latency=0x0000d301
--define_symbol ll_set_conn_tx_power=0x0000d331
--define_symbol ll_set_def_antenna=0x0000d379
--define_symbol ll_set_initiating_coded_scheme=0x0000d395
--define_symbol ll_set_max_conn_number=0x0000d3a1
--define_symbol nibble_for_char=0x0001e225
--define_symbol platform_32k_rc_auto_tune=0x0001e2d1
--define_symbol platform_32k_rc_tune=0x0001e34d
--define_symbol platform_calibrate_32k=0x0001e361
--define_symbol platform_config=0x0001e365
--define_symbol platform_enable_irq=0x0001e48d
--define_symbol platform_get_current_task=0x0001e4c5
--define_symbol platform_get_gen_os_driver=0x0001e4e9
--define_symbol platform_get_heap_status=0x0001e4f1
--define_symbol platform_get_task_handle=0x0001e509
...
--define_symbol platform_install_task_stack=0x0001e549
...
--define_symbol platform_read_persistent_reg=0x0001e5e9
--define_symbol platform_reset=0x0001e5f9
--define_symbol platform_set_evt_callback=0x0001e61d
--define_symbol platform_set_evt_callback_table=0x0001e631
--define_symbol platform_set_irq_callback=0x0001e63d
--define_symbol platform_set_irq_callback_table=0x0001e659
...
--define_symbol platform_set_timer=0x0001e689
...
--define_symbol printf_hexdump=0x0001e889
--define_symbol pvPortMalloc=0x0001f379
--define_symbol pvTaskIncrementMutexHeldCount=0x0001f461
--define_symbol pvTimerGetTimerID=0x0001f479
--define_symbol pxPortInitialiseStack=0x0001f4a5
--define_symbol reverse_128=0x0001f685
--define_symbol reverse_24=0x0001f68b
--define_symbol reverse_48=0x0001f691
--define_symbol reverse_56=0x0001f697
--define_symbol reverse_64=0x0001f69d
--define_symbol reverse_bd_addr=0x0001f6a3
--define_symbol reverse_bytes=0x0001f6a9
--define_symbol sm_add_event_handler=0x0001f969
--define_symbol sm_address_resolution_lookup=0x0001fac1
--define_symbol sm_authenticated=0x0001fe21
--define_symbol sm_authorization_decline=0x0001fe2f
--define_symbol sm_authorization_grant=0x0001fe4f
--define_symbol sm_authorization_state=0x0001fe6f
--define_symbol sm_bonding_decline=0x0001fe89
--define_symbol sm_config=0x000202a9
--define_symbol sm_config_conn=0x000202c1
--define_symbol sm_encryption_key_size=0x00020477
--define_symbol sm_just_works_confirm=0x000209b1
--define_symbol sm_le_device_key=0x00020ced
--define_symbol sm_passkey_input=0x00020d83
--define_symbol sm_private_random_address_generation_get=0x00021131
--define_symbol sm_private_random_address_generation_get_mode=0x00021139
--define_symbol sm_private_random_address_generation_set_mode=0x00021145
--define_symbol sm_private_random_address_generation_set_update_period=0x0002116d
--define_symbol sm_register_oob_data_callback=0x000212a9
--define_symbol sm_request_pairing=0x000212b5
--define_symbol sm_send_security_request=0x00021cef
--define_symbol sm_set_accepted_stk_generation_methods=0x00021d15
--define_symbol sm_set_authentication_requirements=0x00021d21
--define_symbol sm_set_encryption_key_size_range=0x00021d2d
--define_symbol sscanf_bd_addr=0x00022089
--define_symbol sysSetPublicDeviceAddr=0x0002243d
--define_symbol uuid128_to_str=0x00022bb1
--define_symbol uuid_add_bluetooth_prefix=0x00022c09
--define_symbol uuid_has_bluetooth_prefix=0x00022c29
--define_symbol uxListRemove=0x00022c45
--define_symbol uxQueueMessagesWaiting=0x00022c6d
--define_symbol uxQueueMessagesWaitingFromISR=0x00022c95
--define_symbol uxQueueSpacesAvailable=0x00022cb1
--define_symbol uxTaskGetStackHighWaterMark=0x00022cdd
--define_symbol uxTaskPriorityGet=0x00022cfd
--define_symbol uxTaskPriorityGetFromISR=0x00022d19
--define_symbol vListInitialise=0x00022dd3
--define_symbol vListInitialiseItem=0x00022de9
--define_symbol vListInsert=0x00022def
--define_symbol vListInsertEnd=0x00022e1f
--define_symbol vPortEndScheduler=0x00022e39
--define_symbol vPortEnterCritical=0x00022e65
--define_symbol vPortExitCritical=0x00022ea9
--define_symbol vPortFree=0x00022edd
--define_symbol vPortSuppressTicksAndSleep=0x00022f71
--define_symbol vPortValidateInterruptPriority=0x0002308d
--define_symbol vQueueDelete=0x000230e9
--define_symbol vQueueWaitForMessageRestricted=0x00023115
--define_symbol vTaskDelay=0x0002315d
--define_symbol vTaskInternalSetTimeOutState=0x000231a9
--define_symbol vTaskMissedYield=0x000231b9
--define_symbol vTaskPlaceOnEventList=0x000231c5
--define_symbol vTaskPlaceOnEventListRestricted=0x000231fd
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x0002323d
--define_symbol vTaskPrioritySet=0x000232e9
--define_symbol vTaskResume=0x000233b1
--define_symbol vTaskStartScheduler=0x00023435
--define_symbol vTaskStepTick=0x000234c5
--define_symbol vTaskSuspend=0x000234f5
--define_symbol vTaskSuspendAll=0x000235b1
--define_symbol vTaskSwitchContext=0x000235c1
--define_symbol xPortStartScheduler=0x00023669
--define_symbol xQueueAddToSet=0x00023731
--define_symbol xQueueCreateCountingSemaphore=0x00023755
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00023791
--define_symbol xQueueCreateMutex=0x000237d5
--define_symbol xQueueCreateMutexStatic=0x000237eb
--define_symbol xQueueCreateSet=0x00023805
--define_symbol xQueueGenericCreate=0x0002380d
--define_symbol xQueueGenericCreateStatic=0x00023859
--define_symbol xQueueGenericReset=0x000238c1
--define_symbol xQueueGenericSend=0x0002394d
--define_symbol xQueueGenericSendFromISR=0x00023ab9
--define_symbol xQueueGiveFromISR=0x00023b79
--define_symbol xQueueGiveMutexRecursive=0x00023c1d
--define_symbol xQueueIsQueueEmptyFromISR=0x00023c5d
--define_symbol xQueueIsQueueFullFromISR=0x00023c81
--define_symbol xQueuePeek=0x00023ca9
--define_symbol xQueuePeekFromISR=0x00023dd1
--define_symbol xQueueReceive=0x00023e3d
--define_symbol xQueueReceiveFromISR=0x00023f69
--define_symbol xQueueRemoveFromSet=0x00023ffd
--define_symbol xQueueSelectFromSet=0x0002401f
--define_symbol xQueueSelectFromSetFromISR=0x00024031
--define_symbol xQueueSemaphoreTake=0x00024045
--define_symbol xQueueTakeMutexRecursive=0x000241b1
--define_symbol xTaskCheckForTimeOut=0x000241f5
--define_symbol xTaskCreate=0x00024265
--define_symbol xTaskCreateStatic=0x000242c1
--define_symbol xTaskGetCurrentTaskHandle=0x00024331
--define_symbol xTaskGetSchedulerState=0x0002433d
--define_symbol xTaskGetTickCount=0x00024359
--define_symbol xTaskGetTickCountFromISR=0x00024365
--define_symbol xTaskIncrementTick=0x00024375
--define_symbol xTaskPriorityDisinherit=0x00024441
--define_symbol xTaskPriorityInherit=0x000244d5
--define_symbol xTaskRemoveFromEventList=0x00024569
--define_symbol xTaskResumeAll=0x000245e9
--define_symbol xTaskResumeFromISR=0x000246b1
--define_symbol xTimerCreate=0x0002473d
--define_symbol xTimerCreateStatic=0x00024771
--define_symbol xTimerCreateTimerTask=0x000247a9
--define_symbol xTimerGenericCommand=0x00024815
--define_symbol xTimerGetExpiryTime=0x00024885
--define_symbol xTimerGetTimerDaemonTaskHandle=0x000248a5
