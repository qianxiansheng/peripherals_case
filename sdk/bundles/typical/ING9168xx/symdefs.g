...
platform_enable_irq = 0x0201ebfd;
platform_get_current_task = 0x0201ec31;
platform_get_gen_os_driver = 0x0201ec55;
platform_get_heap_status = 0x0201ec5d;
platform_get_task_handle = 0x0201ec75;
platform_get_us_time = 0x0201ec95;
platform_get_version = 0x0201ec99;
platform_hrng = 0x0201eca1;
platform_install_isr_stack = 0x0201eca9;
platform_install_task_stack = 0x0201ecb5;
platform_patch_rf_init_data = 0x0201eced;
platform_printf = 0x0201ecf9;
platform_raise_assertion = 0x0201ed0d;
platform_rand = 0x0201ed21;
platform_read_info = 0x0201ed25;
platform_read_persistent_reg = 0x0201ed55;
platform_reset = 0x0201ed61;
platform_set_evt_callback = 0x0201ed75;
platform_set_evt_callback_table = 0x0201ed89;
platform_set_irq_callback = 0x0201ed95;
platform_set_irq_callback_table = 0x0201edb1;
platform_set_rf_clk_source = 0x0201edbd;
platform_set_rf_init_data = 0x0201edc9;
platform_set_rf_power_mapping = 0x0201edd5;
platform_set_timer = 0x0201ede1;
platform_shutdown = 0x0201ede5;
platform_switch_app = 0x0201ede9;
platform_trace_raw = 0x0201ee01;
platform_write_persistent_reg = 0x0201ee19;
printf_hexdump = 0x0201efd1;
pvPortMalloc = 0x0201faa5;
pvTaskIncrementMutexHeldCount = 0x0201fb8d;
pvTimerGetTimerID = 0x0201fba5;
pxPortInitialiseStack = 0x0201fbd1;
reverse_128 = 0x0201fdb9;
reverse_24 = 0x0201fdbf;
reverse_48 = 0x0201fdc5;
reverse_56 = 0x0201fdcb;
reverse_64 = 0x0201fdd1;
reverse_bd_addr = 0x0201fdd7;
reverse_bytes = 0x0201fddd;
sm_add_event_handler = 0x020200f9;
sm_address_resolution_lookup = 0x02020251;
sm_authenticated = 0x020205b1;
sm_authorization_decline = 0x020205bf;
sm_authorization_grant = 0x020205df;
sm_authorization_state = 0x020205ff;
sm_bonding_decline = 0x02020619;
sm_config = 0x02020a31;
sm_config_conn = 0x02020a49;
sm_encryption_key_size = 0x02020bff;
sm_just_works_confirm = 0x02021139;
sm_le_device_key = 0x02021475;
sm_passkey_input = 0x0202150b;
sm_private_random_address_generation_get = 0x020218b9;
sm_private_random_address_generation_get_mode = 0x020218c1;
sm_private_random_address_generation_set_mode = 0x020218cd;
sm_private_random_address_generation_set_update_period = 0x020218f5;
sm_register_oob_data_callback = 0x02021a31;
sm_request_pairing = 0x02021a3d;
sm_send_security_request = 0x0202247b;
sm_set_accepted_stk_generation_methods = 0x020224a1;
sm_set_authentication_requirements = 0x020224ad;
sm_set_encryption_key_size_range = 0x020224b9;
sscanf_bd_addr = 0x02022819;
sysSetPublicDeviceAddr = 0x02022c85;
uuid128_to_str = 0x02023431;
uuid_add_bluetooth_prefix = 0x02023489;
uuid_has_bluetooth_prefix = 0x020234a9;
uxListRemove = 0x020234c5;
uxQueueMessagesWaiting = 0x020234ed;
uxQueueMessagesWaitingFromISR = 0x02023515;
uxQueueSpacesAvailable = 0x02023531;
uxTaskGetStackHighWaterMark = 0x0202355d;
uxTaskPriorityGet = 0x0202357d;
uxTaskPriorityGetFromISR = 0x02023599;
vListInitialise = 0x0202363f;
vListInitialiseItem = 0x02023655;
vListInsert = 0x0202365b;
vListInsertEnd = 0x0202368b;
vPortEndScheduler = 0x020236a5;
vPortEnterCritical = 0x020236d1;
vPortExitCritical = 0x02023715;
vPortFree = 0x02023749;
vPortSuppressTicksAndSleep = 0x020237ed;
vPortValidateInterruptPriority = 0x02023915;
vQueueDelete = 0x02023971;
vQueueWaitForMessageRestricted = 0x0202399d;
vTaskDelay = 0x020239e1;
vTaskInternalSetTimeOutState = 0x02023a2d;
vTaskMissedYield = 0x02023a3d;
vTaskPlaceOnEventList = 0x02023a49;
vTaskPlaceOnEventListRestricted = 0x02023a81;
vTaskPriorityDisinheritAfterTimeout = 0x02023ac1;
vTaskPrioritySet = 0x02023b6d;
vTaskResume = 0x02023c35;
vTaskStartScheduler = 0x02023cb9;
vTaskStepTick = 0x02023d49;
vTaskSuspend = 0x02023d79;
vTaskSuspendAll = 0x02023e35;
vTaskSwitchContext = 0x02023e45;
xPortStartScheduler = 0x02023eed;
xQueueAddToSet = 0x02023ff1;
xQueueCreateCountingSemaphore = 0x02024015;
xQueueCreateCountingSemaphoreStatic = 0x02024051;
xQueueCreateMutex = 0x02024095;
xQueueCreateMutexStatic = 0x020240ab;
xQueueCreateSet = 0x020240c5;
xQueueGenericCreate = 0x020240cd;
xQueueGenericCreateStatic = 0x02024119;
xQueueGenericReset = 0x02024181;
xQueueGenericSend = 0x0202420d;
xQueueGenericSendFromISR = 0x02024379;
xQueueGiveFromISR = 0x02024439;
xQueueGiveMutexRecursive = 0x020244dd;
xQueueIsQueueEmptyFromISR = 0x0202451d;
xQueueIsQueueFullFromISR = 0x02024541;
xQueuePeek = 0x02024569;
xQueuePeekFromISR = 0x02024691;
xQueueReceive = 0x020246fd;
xQueueReceiveFromISR = 0x02024829;
xQueueRemoveFromSet = 0x020248bd;
xQueueSelectFromSet = 0x020248df;
xQueueSelectFromSetFromISR = 0x020248f1;
xQueueSemaphoreTake = 0x02024905;
xQueueTakeMutexRecursive = 0x02024a71;
xTaskCheckForTimeOut = 0x02024ab5;
xTaskCreate = 0x02024b25;
xTaskCreateStatic = 0x02024b81;
xTaskGetCurrentTaskHandle = 0x02024bf1;
xTaskGetSchedulerState = 0x02024bfd;
xTaskGetTickCount = 0x02024c19;
xTaskGetTickCountFromISR = 0x02024c25;
xTaskIncrementTick = 0x02024c35;
xTaskPriorityDisinherit = 0x02024d01;
xTaskPriorityInherit = 0x02024d95;
xTaskRemoveFromEventList = 0x02024e29;
xTaskResumeAll = 0x02024ea9;
xTaskResumeFromISR = 0x02024f71;
xTimerCreate = 0x02024ffd;
xTimerCreateStatic = 0x02025031;
xTimerCreateTimerTask = 0x02025069;
xTimerGenericCommand = 0x020250d5;
xTimerGetExpiryTime = 0x02025145;
xTimerGetTimerDaemonTaskHandle = 0x02025165;
