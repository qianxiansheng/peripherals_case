...
platform_controller_run = 0x0001cf9d;
platform_enable_irq = 0x0001cfd5;
...
platform_set_evt_callback = 0x0001d111;
platform_set_evt_callback_table = 0x0001d125;
platform_set_irq_callback = 0x0001d131;
platform_set_irq_callback_table = 0x0001d14d;
platform_set_rf_clk_source = 0x0001d159;
platform_set_rf_init_data = 0x0001d165;
platform_set_rf_power_mapping = 0x0001d171;
platform_set_timer = 0x0001d17d;
platform_shutdown = 0x0001d181;
platform_switch_app = 0x0001d185;
platform_trace_raw = 0x0001d1b1;
platform_write_persistent_reg = 0x0001d1c9;
printf_hexdump = 0x0001d1d9;
reverse_128 = 0x0001d515;
reverse_24 = 0x0001d51b;
reverse_48 = 0x0001d521;
reverse_56 = 0x0001d527;
reverse_64 = 0x0001d52d;
reverse_bd_addr = 0x0001d533;
reverse_bytes = 0x0001d539;
sm_add_event_handler = 0x0001d6a5;
sm_address_resolution_lookup = 0x0001d7fd;
sm_authenticated = 0x0001db5d;
sm_authorization_decline = 0x0001db6b;
sm_authorization_grant = 0x0001db8b;
sm_authorization_state = 0x0001dbab;
sm_bonding_decline = 0x0001dbc5;
sm_config = 0x0001dfe5;
sm_config_conn = 0x0001dffd;
sm_encryption_key_size = 0x0001e1b3;
sm_just_works_confirm = 0x0001e6ed;
sm_le_device_key = 0x0001ea29;
sm_passkey_input = 0x0001eabf;
sm_private_random_address_generation_get = 0x0001ee6d;
sm_private_random_address_generation_get_mode = 0x0001ee75;
sm_private_random_address_generation_set_mode = 0x0001ee81;
sm_private_random_address_generation_set_update_period = 0x0001eea9;
sm_register_oob_data_callback = 0x0001efe5;
sm_request_pairing = 0x0001eff1;
...
sysSetPublicDeviceAddr = 0x00020179;
uuid128_to_str = 0x0002075d;
uuid_add_bluetooth_prefix = 0x000207b5;
uuid_has_bluetooth_prefix = 0x000207d5;
