...
platform_enable_irq = 0x0201ea31;
...
platform_set_evt_callback_table = 0x0201ebbd;
platform_set_irq_callback = 0x0201ebc9;
platform_set_irq_callback_table = 0x0201ebe5;
platform_set_rf_clk_source = 0x0201ebf1;
platform_set_rf_init_data = 0x0201ebfd;
platform_set_rf_power_mapping = 0x0201ec09;
platform_set_timer = 0x0201ec15;
platform_shutdown = 0x0201ec19;
platform_switch_app = 0x0201ec1d;
platform_trace_raw = 0x0201ec35;
platform_write_persistent_reg = 0x0201ec4d;
printf_hexdump = 0x0201ee05;
pvPortMalloc = 0x0201f8d1;
pvTaskIncrementMutexHeldCount = 0x0201f9b9;
pvTimerGetTimerID = 0x0201f9d1;
pxPortInitialiseStack = 0x0201f9fd;
reverse_128 = 0x0201fbe5;
reverse_24 = 0x0201fbeb;
reverse_48 = 0x0201fbf1;
reverse_56 = 0x0201fbf7;
reverse_64 = 0x0201fbfd;
reverse_bd_addr = 0x0201fc03;
reverse_bytes = 0x0201fc09;
sm_add_event_handler = 0x0201ff25;
sm_address_resolution_lookup = 0x0202007d;
sm_authenticated = 0x020203dd;
sm_authorization_decline = 0x020203eb;
sm_authorization_grant = 0x0202040b;
sm_authorization_state = 0x0202042b;
sm_bonding_decline = 0x02020445;
sm_config = 0x0202085d;
sm_config_conn = 0x02020875;
sm_encryption_key_size = 0x02020a2b;
sm_just_works_confirm = 0x02020f65;
sm_le_device_key = 0x020212a1;
sm_passkey_input = 0x02021337;
sm_private_random_address_generation_get = 0x020216e5;
sm_private_random_address_generation_get_mode = 0x020216ed;
sm_private_random_address_generation_set_mode = 0x020216f9;
sm_private_random_address_generation_set_update_period = 0x02021721;
sm_register_oob_data_callback = 0x0202185d;
sm_request_pairing = 0x02021869;
sm_send_security_request = 0x020222a7;
sm_set_accepted_stk_generation_methods = 0x020222cd;
sm_set_authentication_requirements = 0x020222d9;
sm_set_encryption_key_size_range = 0x020222e5;
sscanf_bd_addr = 0x02022645;
sysSetPublicDeviceAddr = 0x02022ab1;
uuid128_to_str = 0x0202325d;
uuid_add_bluetooth_prefix = 0x020232b5;
uuid_has_bluetooth_prefix = 0x020232d5;
uxListRemove = 0x020232f1;
uxQueueMessagesWaiting = 0x02023319;
uxQueueMessagesWaitingFromISR = 0x02023341;
uxQueueSpacesAvailable = 0x0202335d;
uxTaskGetStackHighWaterMark = 0x02023389;
uxTaskPriorityGet = 0x020233a9;
uxTaskPriorityGetFromISR = 0x020233c5;
...
vPortExitCritical = 0x02023541;
vPortFree = 0x02023575;
vPortSuppressTicksAndSleep = 0x02023619;
vPortValidateInterruptPriority = 0x02023741;
vQueueDelete = 0x0202379d;
vQueueWaitForMessageRestricted = 0x020237c9;
vTaskDelay = 0x0202380d;
vTaskInternalSetTimeOutState = 0x02023859;
vTaskMissedYield = 0x02023869;
vTaskPlaceOnEventList = 0x02023875;
vTaskPlaceOnEventListRestricted = 0x020238ad;
vTaskPriorityDisinheritAfterTimeout = 0x020238ed;
vTaskPrioritySet = 0x02023999;
vTaskResume = 0x02023a61;
vTaskStartScheduler = 0x02023ae5;
vTaskStepTick = 0x02023b75;
vTaskSuspend = 0x02023ba5;
vTaskSuspendAll = 0x02023c61;
vTaskSwitchContext = 0x02023c71;
xPortStartScheduler = 0x02023d15;
xQueueAddToSet = 0x02023e19;
xQueueCreateCountingSemaphore = 0x02023e3d;
xQueueCreateCountingSemaphoreStatic = 0x02023e79;
xQueueCreateMutex = 0x02023ebd;
xQueueCreateMutexStatic = 0x02023ed3;
xQueueCreateSet = 0x02023eed;
xQueueGenericCreate = 0x02023ef5;
xQueueGenericCreateStatic = 0x02023f41;
xQueueGenericReset = 0x02023fa9;
xQueueGenericSend = 0x02024035;
xQueueGenericSendFromISR = 0x020241a1;
xQueueGiveFromISR = 0x02024261;
xQueueGiveMutexRecursive = 0x02024305;
xQueueIsQueueEmptyFromISR = 0x02024345;
xQueueIsQueueFullFromISR = 0x02024369;
xQueuePeek = 0x02024391;
xQueuePeekFromISR = 0x020244b9;
xQueueReceive = 0x02024525;
xQueueReceiveFromISR = 0x02024651;
xQueueRemoveFromSet = 0x020246e5;
xQueueSelectFromSet = 0x02024707;
xQueueSelectFromSetFromISR = 0x02024719;
xQueueSemaphoreTake = 0x0202472d;
xQueueTakeMutexRecursive = 0x02024899;
xTaskCheckForTimeOut = 0x020248dd;
xTaskCreate = 0x0202494d;
xTaskCreateStatic = 0x020249a9;
xTaskGetCurrentTaskHandle = 0x02024a19;
xTaskGetSchedulerState = 0x02024a25;
xTaskGetTickCount = 0x02024a41;
xTaskGetTickCountFromISR = 0x02024a4d;
xTaskIncrementTick = 0x02024a5d;
xTaskPriorityDisinherit = 0x02024b29;
xTaskPriorityInherit = 0x02024bbd;
xTaskRemoveFromEventList = 0x02024c51;
xTaskResumeAll = 0x02024cd1;
xTaskResumeFromISR = 0x02024d99;
xTimerCreate = 0x02024e25;
xTimerCreateStatic = 0x02024e59;
xTimerCreateTimerTask = 0x02024e91;
xTimerGenericCommand = 0x02024efd;
xTimerGetExpiryTime = 0x02024f6d;
xTimerGetTimerDaemonTaskHandle = 0x02024f8d;
