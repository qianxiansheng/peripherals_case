...
platform_controller_run = 0x0001cdcd;
platform_enable_irq = 0x0001ce05;
platform_get_gen_os_driver = 0x0001ce3d;
platform_get_task_handle = 0x0001ce49;
platform_get_us_time = 0x0001ce61;
platform_get_version = 0x0001ce65;
platform_hrng = 0x0001ce6d;
platform_init_controller = 0x0001ce75;
platform_os_idle_resumed_hook = 0x0001ce91;
platform_patch_rf_init_data = 0x0001ce95;
platform_post_sleep_processing = 0x0001cea1;
platform_pre_sleep_processing = 0x0001cea7;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001cead;
platform_printf = 0x0001ceb1;
platform_raise_assertion = 0x0001cec5;
platform_rand = 0x0001ced9;
platform_read_info = 0x0001cedd;
platform_read_persistent_reg = 0x0001cf0d;
platform_reset = 0x0001cf1d;
platform_set_evt_callback = 0x0001cf41;
platform_set_evt_callback_table = 0x0001cf55;
platform_set_irq_callback = 0x0001cf61;
platform_set_irq_callback_table = 0x0001cf7d;
platform_set_rf_clk_source = 0x0001cf89;
platform_set_rf_init_data = 0x0001cf95;
platform_set_rf_power_mapping = 0x0001cfa1;
platform_set_timer = 0x0001cfad;
platform_shutdown = 0x0001cfb1;
platform_switch_app = 0x0001cfb5;
platform_trace_raw = 0x0001cfe1;
platform_write_persistent_reg = 0x0001cff9;
printf_hexdump = 0x0001d009;
reverse_128 = 0x0001d33d;
reverse_24 = 0x0001d343;
reverse_48 = 0x0001d349;
reverse_56 = 0x0001d34f;
reverse_64 = 0x0001d355;
reverse_bd_addr = 0x0001d35b;
reverse_bytes = 0x0001d361;
sm_add_event_handler = 0x0001d4cd;
sm_address_resolution_lookup = 0x0001d625;
sm_authenticated = 0x0001d985;
sm_authorization_decline = 0x0001d993;
sm_authorization_grant = 0x0001d9b3;
sm_authorization_state = 0x0001d9d3;
sm_bonding_decline = 0x0001d9ed;
sm_config = 0x0001de0d;
sm_config_conn = 0x0001de25;
sm_encryption_key_size = 0x0001dfdb;
sm_just_works_confirm = 0x0001e515;
sm_le_device_key = 0x0001e851;
sm_passkey_input = 0x0001e8e7;
sm_private_random_address_generation_get = 0x0001ec95;
sm_private_random_address_generation_get_mode = 0x0001ec9d;
sm_private_random_address_generation_set_mode = 0x0001eca9;
sm_private_random_address_generation_set_update_period = 0x0001ecd1;
sm_register_oob_data_callback = 0x0001ee0d;
sm_request_pairing = 0x0001ee19;
sm_send_security_request = 0x0001f853;
sm_set_accepted_stk_generation_methods = 0x0001f879;
sm_set_authentication_requirements = 0x0001f885;
sm_set_encryption_key_size_range = 0x0001f891;
sscanf_bd_addr = 0x0001fbed;
sysSetPublicDeviceAddr = 0x0001ffa1;
uuid128_to_str = 0x00020585;
uuid_add_bluetooth_prefix = 0x000205dd;
uuid_has_bluetooth_prefix = 0x000205fd;
