...
ll_config = 0x0200bd41;
ll_free = 0x0200bd51;
ll_hint_on_ce_len = 0x0200bd5d;
ll_legacy_adv_set_interval = 0x0200bd95;
ll_malloc = 0x0200bda5;
ll_scan_set_fixed_channel = 0x0200bf15;
ll_set_adv_access_address = 0x0200c029;
ll_set_adv_coded_scheme = 0x0200c035;
ll_set_conn_coded_scheme = 0x0200c06d;
ll_set_conn_latency = 0x0200c099;
ll_set_conn_tx_power = 0x0200c0c9;
ll_set_def_antenna = 0x0200c105;
ll_set_initiating_coded_scheme = 0x0200c125;
ll_set_max_conn_number = 0x0200c131;
ll_set_tx_power_range = 0x0200c1cd;
nibble_for_char = 0x0201ea4d;
platform_32k_rc_auto_tune = 0x0201eaf9;
platform_32k_rc_tune = 0x0201eb45;
platform_calibrate_32k = 0x0201eb61;
platform_config = 0x0201eb65;
platform_enable_irq = 0x0201ec89;
platform_get_current_task = 0x0201ecbd;
platform_get_gen_os_driver = 0x0201ece1;
platform_get_heap_status = 0x0201ece9;
platform_get_task_handle = 0x0201ed01;
platform_get_us_time = 0x0201ed21;
platform_get_version = 0x0201ed25;
platform_hrng = 0x0201ed2d;
platform_install_isr_stack = 0x0201ed35;
platform_install_task_stack = 0x0201ed41;
platform_patch_rf_init_data = 0x0201ed79;
platform_printf = 0x0201ed85;
platform_raise_assertion = 0x0201ed99;
platform_rand = 0x0201edad;
platform_read_info = 0x0201edb1;
platform_read_persistent_reg = 0x0201ede1;
platform_reset = 0x0201eded;
platform_set_evt_callback = 0x0201ee01;
platform_set_evt_callback_table = 0x0201ee15;
platform_set_irq_callback = 0x0201ee21;
platform_set_irq_callback_table = 0x0201ee3d;
platform_set_rf_clk_source = 0x0201ee49;
platform_set_rf_init_data = 0x0201ee55;
platform_set_rf_power_mapping = 0x0201ee61;
platform_set_timer = 0x0201ee6d;
platform_shutdown = 0x0201ee71;
platform_switch_app = 0x0201ee75;
platform_trace_raw = 0x0201ee8d;
platform_write_persistent_reg = 0x0201eea5;
printf_hexdump = 0x0201f05d;
pvPortMalloc = 0x0201fb31;
pvTaskIncrementMutexHeldCount = 0x0201fc19;
pvTimerGetTimerID = 0x0201fc31;
pxPortInitialiseStack = 0x0201fc5d;
reverse_128 = 0x0201fe45;
reverse_24 = 0x0201fe4b;
reverse_48 = 0x0201fe51;
reverse_56 = 0x0201fe57;
reverse_64 = 0x0201fe5d;
reverse_bd_addr = 0x0201fe63;
reverse_bytes = 0x0201fe69;
sm_add_event_handler = 0x02020185;
sm_address_resolution_lookup = 0x020202dd;
sm_authenticated = 0x0202063d;
sm_authorization_decline = 0x0202064b;
sm_authorization_grant = 0x0202066b;
sm_authorization_state = 0x0202068b;
sm_bonding_decline = 0x020206a5;
sm_config = 0x02020abd;
sm_config_conn = 0x02020ad5;
sm_encryption_key_size = 0x02020c8b;
sm_just_works_confirm = 0x020211c5;
sm_le_device_key = 0x02021501;
sm_passkey_input = 0x02021597;
sm_private_random_address_generation_get = 0x02021945;
sm_private_random_address_generation_get_mode = 0x0202194d;
sm_private_random_address_generation_set_mode = 0x02021959;
sm_private_random_address_generation_set_update_period = 0x02021981;
sm_register_oob_data_callback = 0x02021abd;
sm_request_pairing = 0x02021ac9;
sm_send_security_request = 0x02022507;
sm_set_accepted_stk_generation_methods = 0x0202252d;
sm_set_authentication_requirements = 0x02022539;
sm_set_encryption_key_size_range = 0x02022545;
sscanf_bd_addr = 0x020228a5;
sysSetPublicDeviceAddr = 0x02022d11;
uuid128_to_str = 0x020234bd;
uuid_add_bluetooth_prefix = 0x02023515;
uuid_has_bluetooth_prefix = 0x02023535;
uxListRemove = 0x02023551;
uxQueueMessagesWaiting = 0x02023579;
uxQueueMessagesWaitingFromISR = 0x020235a1;
uxQueueSpacesAvailable = 0x020235bd;
uxTaskGetStackHighWaterMark = 0x020235e9;
uxTaskPriorityGet = 0x02023609;
uxTaskPriorityGetFromISR = 0x02023625;
vListInitialise = 0x020236cb;
vListInitialiseItem = 0x020236e1;
vListInsert = 0x020236e7;
vListInsertEnd = 0x02023717;
vPortEndScheduler = 0x02023731;
vPortEnterCritical = 0x0202375d;
vPortExitCritical = 0x020237a1;
vPortFree = 0x020237d5;
vPortSuppressTicksAndSleep = 0x02023879;
vPortValidateInterruptPriority = 0x020239a1;
vQueueDelete = 0x020239fd;
vQueueWaitForMessageRestricted = 0x02023a29;
vTaskDelay = 0x02023a6d;
vTaskInternalSetTimeOutState = 0x02023ab9;
vTaskMissedYield = 0x02023ac9;
vTaskPlaceOnEventList = 0x02023ad5;
vTaskPlaceOnEventListRestricted = 0x02023b0d;
vTaskPriorityDisinheritAfterTimeout = 0x02023b4d;
vTaskPrioritySet = 0x02023bf9;
vTaskResume = 0x02023cc1;
vTaskStartScheduler = 0x02023d45;
vTaskStepTick = 0x02023dd5;
vTaskSuspend = 0x02023e05;
vTaskSuspendAll = 0x02023ec1;
vTaskSwitchContext = 0x02023ed1;
xPortStartScheduler = 0x02023f79;
xQueueAddToSet = 0x0202407d;
xQueueCreateCountingSemaphore = 0x020240a1;
xQueueCreateCountingSemaphoreStatic = 0x020240dd;
xQueueCreateMutex = 0x02024121;
xQueueCreateMutexStatic = 0x02024137;
xQueueCreateSet = 0x02024151;
xQueueGenericCreate = 0x02024159;
xQueueGenericCreateStatic = 0x020241a5;
xQueueGenericReset = 0x0202420d;
xQueueGenericSend = 0x02024299;
xQueueGenericSendFromISR = 0x02024405;
xQueueGiveFromISR = 0x020244c5;
xQueueGiveMutexRecursive = 0x02024569;
xQueueIsQueueEmptyFromISR = 0x020245a9;
xQueueIsQueueFullFromISR = 0x020245cd;
xQueuePeek = 0x020245f5;
xQueuePeekFromISR = 0x0202471d;
xQueueReceive = 0x02024789;
xQueueReceiveFromISR = 0x020248b5;
xQueueRemoveFromSet = 0x02024949;
xQueueSelectFromSet = 0x0202496b;
xQueueSelectFromSetFromISR = 0x0202497d;
xQueueSemaphoreTake = 0x02024991;
xQueueTakeMutexRecursive = 0x02024afd;
xTaskCheckForTimeOut = 0x02024b41;
xTaskCreate = 0x02024bb1;
xTaskCreateStatic = 0x02024c0d;
xTaskGetCurrentTaskHandle = 0x02024c7d;
xTaskGetSchedulerState = 0x02024c89;
xTaskGetTickCount = 0x02024ca5;
xTaskGetTickCountFromISR = 0x02024cb1;
xTaskIncrementTick = 0x02024cc1;
xTaskPriorityDisinherit = 0x02024d8d;
xTaskPriorityInherit = 0x02024e21;
xTaskRemoveFromEventList = 0x02024eb5;
xTaskResumeAll = 0x02024f35;
xTaskResumeFromISR = 0x02024ffd;
xTimerCreate = 0x02025089;
xTimerCreateStatic = 0x020250bd;
xTimerCreateTimerTask = 0x020250f5;
xTimerGenericCommand = 0x02025161;
xTimerGetExpiryTime = 0x020251d1;
xTimerGetTimerDaemonTaskHandle = 0x020251f1;
