...
platform_controller_run = 0x0201fba9;
platform_enable_irq = 0x0201fbe1;
platform_get_gen_os_driver = 0x0201fc15;
platform_get_task_handle = 0x0201fc21;
platform_get_us_time = 0x0201fc39;
platform_get_version = 0x0201fc3d;
platform_hrng = 0x0201fc45;
platform_init_controller = 0x0201fc4d;
platform_os_idle_resumed_hook = 0x0201fc69;
platform_patch_rf_init_data = 0x0201fc6d;
platform_post_sleep_processing = 0x0201fc79;
platform_pre_sleep_processing = 0x0201fc7f;
platform_pre_suppress_ticks_and_sleep_processing = 0x0201fc85;
platform_printf = 0x0201fc89;
platform_raise_assertion = 0x0201fc9d;
platform_rand = 0x0201fcb1;
platform_read_info = 0x0201fcb5;
platform_read_persistent_reg = 0x0201fce5;
platform_reset = 0x0201fcf1;
platform_set_evt_callback = 0x0201fd05;
platform_set_evt_callback_table = 0x0201fd19;
platform_set_irq_callback = 0x0201fd25;
platform_set_irq_callback_table = 0x0201fd41;
platform_set_rf_clk_source = 0x0201fd4d;
platform_set_rf_init_data = 0x0201fd59;
platform_set_rf_power_mapping = 0x0201fd65;
platform_set_timer = 0x0201fd71;
platform_shutdown = 0x0201fd75;
platform_switch_app = 0x0201fd79;
platform_trace_raw = 0x0201fd91;
platform_write_persistent_reg = 0x0201fda9;
printf_hexdump = 0x0201fdbd;
reverse_128 = 0x02020131;
reverse_24 = 0x02020137;
reverse_48 = 0x0202013d;
reverse_56 = 0x02020143;
reverse_64 = 0x02020149;
reverse_bd_addr = 0x0202014f;
reverse_bytes = 0x02020155;
sm_add_event_handler = 0x02020491;
sm_address_resolution_lookup = 0x020205e9;
sm_authenticated = 0x02020949;
sm_authorization_decline = 0x02020957;
sm_authorization_grant = 0x02020977;
sm_authorization_state = 0x02020997;
sm_bonding_decline = 0x020209b1;
sm_config = 0x02020dc9;
sm_config_conn = 0x02020de1;
sm_encryption_key_size = 0x02020f97;
sm_just_works_confirm = 0x020214d1;
sm_le_device_key = 0x0202180d;
sm_passkey_input = 0x020218a3;
sm_private_random_address_generation_get = 0x02021c51;
sm_private_random_address_generation_get_mode = 0x02021c59;
sm_private_random_address_generation_set_mode = 0x02021c65;
sm_private_random_address_generation_set_update_period = 0x02021c8d;
sm_register_oob_data_callback = 0x02021dc9;
sm_request_pairing = 0x02021dd5;
sm_send_security_request = 0x02022813;
sm_set_accepted_stk_generation_methods = 0x02022839;
sm_set_authentication_requirements = 0x02022845;
sm_set_encryption_key_size_range = 0x02022851;
sscanf_bd_addr = 0x02022c29;
sysSetPublicDeviceAddr = 0x02023095;
uuid128_to_str = 0x02023845;
uuid_add_bluetooth_prefix = 0x0202389d;
uuid_has_bluetooth_prefix = 0x020238bd;
