...
platform_controller_run = 0x0001d9c1;
platform_enable_irq = 0x0001d9f9;
platform_get_gen_os_driver = 0x0001da31;
platform_get_task_handle = 0x0001da3d;
platform_get_us_time = 0x0001da55;
platform_get_version = 0x0001da59;
platform_hrng = 0x0001da61;
platform_init_controller = 0x0001da69;
platform_os_idle_resumed_hook = 0x0001da85;
platform_patch_rf_init_data = 0x0001da89;
platform_post_sleep_processing = 0x0001da95;
platform_pre_sleep_processing = 0x0001da9b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001daa1;
platform_printf = 0x0001daa5;
platform_raise_assertion = 0x0001dab9;
platform_rand = 0x0001dacd;
platform_read_info = 0x0001dad1;
platform_read_persistent_reg = 0x0001db01;
platform_reset = 0x0001db11;
platform_set_evt_callback = 0x0001db35;
platform_set_evt_callback_table = 0x0001db49;
platform_set_irq_callback = 0x0001db55;
platform_set_irq_callback_table = 0x0001db71;
platform_set_rf_clk_source = 0x0001db7d;
platform_set_rf_init_data = 0x0001db89;
platform_set_rf_power_mapping = 0x0001db95;
platform_set_timer = 0x0001dba1;
platform_shutdown = 0x0001dba5;
platform_switch_app = 0x0001dba9;
platform_trace_raw = 0x0001dbd5;
platform_write_persistent_reg = 0x0001dbed;
printf_hexdump = 0x0001dbfd;
reverse_128 = 0x0001df39;
reverse_24 = 0x0001df3f;
reverse_48 = 0x0001df45;
reverse_56 = 0x0001df4b;
reverse_64 = 0x0001df51;
reverse_bd_addr = 0x0001df57;
reverse_bytes = 0x0001df5d;
sm_add_event_handler = 0x0001e0e9;
sm_address_resolution_lookup = 0x0001e241;
sm_authenticated = 0x0001e5a1;
sm_authorization_decline = 0x0001e5af;
sm_authorization_grant = 0x0001e5cf;
sm_authorization_state = 0x0001e5ef;
sm_bonding_decline = 0x0001e609;
sm_config = 0x0001ea29;
sm_config_conn = 0x0001ea41;
sm_encryption_key_size = 0x0001ebf7;
...
sm_register_oob_data_callback = 0x0001fa29;
sm_request_pairing = 0x0001fa35;
sm_send_security_request = 0x0002046f;
sm_set_accepted_stk_generation_methods = 0x00020495;
sm_set_authentication_requirements = 0x000204a1;
sm_set_encryption_key_size_range = 0x000204ad;
sscanf_bd_addr = 0x0002087d;
sysSetPublicDeviceAddr = 0x00020c31;
uuid128_to_str = 0x00021215;
uuid_add_bluetooth_prefix = 0x0002126d;
uuid_has_bluetooth_prefix = 0x0002128d;
