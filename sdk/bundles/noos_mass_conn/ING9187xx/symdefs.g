...
platform_enable_irq = 0x0001d00d;
platform_get_gen_os_driver = 0x0001d045;
...
platform_init_controller = 0x0001d07d;
platform_os_idle_resumed_hook = 0x0001d099;
platform_patch_rf_init_data = 0x0001d09d;
platform_post_sleep_processing = 0x0001d0a9;
platform_pre_sleep_processing = 0x0001d0af;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001d0b5;
platform_printf = 0x0001d0b9;
platform_raise_assertion = 0x0001d0cd;
platform_rand = 0x0001d0e1;
platform_read_info = 0x0001d0e5;
platform_read_persistent_reg = 0x0001d115;
platform_reset = 0x0001d125;
platform_set_evt_callback = 0x0001d149;
platform_set_evt_callback_table = 0x0001d15d;
platform_set_irq_callback = 0x0001d169;
platform_set_irq_callback_table = 0x0001d185;
platform_set_rf_clk_source = 0x0001d191;
platform_set_rf_init_data = 0x0001d19d;
platform_set_rf_power_mapping = 0x0001d1a9;
platform_set_timer = 0x0001d1b5;
platform_shutdown = 0x0001d1b9;
platform_switch_app = 0x0001d1bd;
platform_trace_raw = 0x0001d1e9;
platform_write_persistent_reg = 0x0001d201;
printf_hexdump = 0x0001d211;
reverse_128 = 0x0001d54d;
reverse_24 = 0x0001d553;
reverse_48 = 0x0001d559;
reverse_56 = 0x0001d55f;
reverse_64 = 0x0001d565;
reverse_bd_addr = 0x0001d56b;
reverse_bytes = 0x0001d571;
sm_add_event_handler = 0x0001d6dd;
sm_address_resolution_lookup = 0x0001d835;
sm_authenticated = 0x0001db95;
sm_authorization_decline = 0x0001dba3;
sm_authorization_grant = 0x0001dbc3;
sm_authorization_state = 0x0001dbe3;
sm_bonding_decline = 0x0001dbfd;
sm_config = 0x0001e01d;
sm_config_conn = 0x0001e035;
sm_encryption_key_size = 0x0001e1eb;
sm_just_works_confirm = 0x0001e725;
sm_le_device_key = 0x0001ea61;
sm_passkey_input = 0x0001eaf7;
sm_private_random_address_generation_get = 0x0001eea5;
sm_private_random_address_generation_get_mode = 0x0001eead;
sm_private_random_address_generation_set_mode = 0x0001eeb9;
sm_private_random_address_generation_set_update_period = 0x0001eee1;
sm_register_oob_data_callback = 0x0001f01d;
sm_request_pairing = 0x0001f029;
sm_send_security_request = 0x0001fa63;
sm_set_accepted_stk_generation_methods = 0x0001fa89;
sm_set_authentication_requirements = 0x0001fa95;
sm_set_encryption_key_size_range = 0x0001faa1;
sscanf_bd_addr = 0x0001fdfd;
sysSetPublicDeviceAddr = 0x000201b1;
uuid128_to_str = 0x00020795;
uuid_add_bluetooth_prefix = 0x000207ed;
uuid_has_bluetooth_prefix = 0x0002080d;
