...
platform_enable_irq = 0x0001e435;
platform_get_current_task = 0x0001e46d;
platform_get_gen_os_driver = 0x0001e491;
platform_get_heap_status = 0x0001e499;
platform_get_task_handle = 0x0001e4b1;
platform_get_us_time = 0x0001e4d1;
platform_get_version = 0x0001e4d5;
platform_hrng = 0x0001e4dd;
platform_install_isr_stack = 0x0001e4e5;
platform_install_task_stack = 0x0001e4f1;
platform_patch_rf_init_data = 0x0001e529;
platform_printf = 0x0001e535;
platform_raise_assertion = 0x0001e549;
platform_rand = 0x0001e55d;
platform_read_info = 0x0001e561;
platform_read_persistent_reg = 0x0001e591;
platform_reset = 0x0001e5a1;
platform_set_evt_callback = 0x0001e5c5;
platform_set_evt_callback_table = 0x0001e5d9;
platform_set_irq_callback = 0x0001e5e5;
platform_set_irq_callback_table = 0x0001e601;
platform_set_rf_clk_source = 0x0001e60d;
platform_set_rf_init_data = 0x0001e619;
platform_set_rf_power_mapping = 0x0001e625;
platform_set_timer = 0x0001e631;
platform_shutdown = 0x0001e635;
platform_switch_app = 0x0001e639;
platform_trace_raw = 0x0001e665;
platform_write_persistent_reg = 0x0001e67d;
printf_hexdump = 0x0001e831;
pvPortMalloc = 0x0001f321;
pvTaskIncrementMutexHeldCount = 0x0001f409;
pvTimerGetTimerID = 0x0001f421;
pxPortInitialiseStack = 0x0001f44d;
reverse_128 = 0x0001f62d;
reverse_24 = 0x0001f633;
reverse_48 = 0x0001f639;
reverse_56 = 0x0001f63f;
reverse_64 = 0x0001f645;
reverse_bd_addr = 0x0001f64b;
reverse_bytes = 0x0001f651;
sm_add_event_handler = 0x0001f911;
sm_address_resolution_lookup = 0x0001fa69;
sm_authenticated = 0x0001fdc9;
sm_authorization_decline = 0x0001fdd7;
sm_authorization_grant = 0x0001fdf7;
sm_authorization_state = 0x0001fe17;
sm_bonding_decline = 0x0001fe31;
sm_config = 0x00020251;
sm_config_conn = 0x00020269;
sm_encryption_key_size = 0x0002041f;
sm_just_works_confirm = 0x00020959;
sm_le_device_key = 0x00020c95;
sm_passkey_input = 0x00020d2b;
sm_private_random_address_generation_get = 0x000210d9;
sm_private_random_address_generation_get_mode = 0x000210e1;
sm_private_random_address_generation_set_mode = 0x000210ed;
sm_private_random_address_generation_set_update_period = 0x00021115;
sm_register_oob_data_callback = 0x00021251;
sm_request_pairing = 0x0002125d;
sm_send_security_request = 0x00021c97;
sm_set_accepted_stk_generation_methods = 0x00021cbd;
sm_set_authentication_requirements = 0x00021cc9;
sm_set_encryption_key_size_range = 0x00021cd5;
sscanf_bd_addr = 0x00022031;
sysSetPublicDeviceAddr = 0x000223e5;
uuid128_to_str = 0x00022b59;
uuid_add_bluetooth_prefix = 0x00022bb1;
uuid_has_bluetooth_prefix = 0x00022bd1;
uxListRemove = 0x00022bed;
uxQueueMessagesWaiting = 0x00022c15;
uxQueueMessagesWaitingFromISR = 0x00022c3d;
uxQueueSpacesAvailable = 0x00022c59;
uxTaskGetStackHighWaterMark = 0x00022c85;
uxTaskPriorityGet = 0x00022ca5;
uxTaskPriorityGetFromISR = 0x00022cc1;
vListInitialise = 0x00022d7b;
vListInitialiseItem = 0x00022d91;
vListInsert = 0x00022d97;
vListInsertEnd = 0x00022dc7;
vPortEndScheduler = 0x00022de1;
vPortEnterCritical = 0x00022e0d;
vPortExitCritical = 0x00022e51;
vPortFree = 0x00022e85;
vPortSuppressTicksAndSleep = 0x00022f19;
vPortValidateInterruptPriority = 0x00023035;
vQueueDelete = 0x00023091;
vQueueWaitForMessageRestricted = 0x000230bd;
vTaskDelay = 0x00023105;
vTaskInternalSetTimeOutState = 0x00023151;
vTaskMissedYield = 0x00023161;
vTaskPlaceOnEventList = 0x0002316d;
vTaskPlaceOnEventListRestricted = 0x000231a5;
vTaskPriorityDisinheritAfterTimeout = 0x000231e5;
vTaskPrioritySet = 0x00023291;
vTaskResume = 0x00023359;
vTaskStartScheduler = 0x000233dd;
vTaskStepTick = 0x0002346d;
vTaskSuspend = 0x0002349d;
vTaskSuspendAll = 0x00023559;
vTaskSwitchContext = 0x00023569;
xPortStartScheduler = 0x00023611;
xQueueAddToSet = 0x000236d9;
xQueueCreateCountingSemaphore = 0x000236fd;
xQueueCreateCountingSemaphoreStatic = 0x00023739;
xQueueCreateMutex = 0x0002377d;
xQueueCreateMutexStatic = 0x00023793;
xQueueCreateSet = 0x000237ad;
xQueueGenericCreate = 0x000237b5;
xQueueGenericCreateStatic = 0x00023801;
xQueueGenericReset = 0x00023869;
xQueueGenericSend = 0x000238f5;
xQueueGenericSendFromISR = 0x00023a61;
xQueueGiveFromISR = 0x00023b21;
xQueueGiveMutexRecursive = 0x00023bc5;
xQueueIsQueueEmptyFromISR = 0x00023c05;
xQueueIsQueueFullFromISR = 0x00023c29;
xQueuePeek = 0x00023c51;
xQueuePeekFromISR = 0x00023d79;
xQueueReceive = 0x00023de5;
xQueueReceiveFromISR = 0x00023f11;
xQueueRemoveFromSet = 0x00023fa5;
xQueueSelectFromSet = 0x00023fc7;
xQueueSelectFromSetFromISR = 0x00023fd9;
xQueueSemaphoreTake = 0x00023fed;
xQueueTakeMutexRecursive = 0x00024159;
xTaskCheckForTimeOut = 0x0002419d;
xTaskCreate = 0x0002420d;
xTaskCreateStatic = 0x00024269;
xTaskGetCurrentTaskHandle = 0x000242d9;
xTaskGetSchedulerState = 0x000242e5;
xTaskGetTickCount = 0x00024301;
xTaskGetTickCountFromISR = 0x0002430d;
xTaskIncrementTick = 0x0002431d;
xTaskPriorityDisinherit = 0x000243e9;
xTaskPriorityInherit = 0x0002447d;
xTaskRemoveFromEventList = 0x00024511;
xTaskResumeAll = 0x00024591;
xTaskResumeFromISR = 0x00024659;
xTimerCreate = 0x000246e5;
xTimerCreateStatic = 0x00024719;
xTimerCreateTimerTask = 0x00024751;
xTimerGenericCommand = 0x000247bd;
xTimerGetExpiryTime = 0x0002482d;
xTimerGetTimerDaemonTaskHandle = 0x0002484d;
