...
platform_enable_irq = 0x0001db4d;
platform_get_current_task = 0x0001db85;
platform_get_gen_os_driver = 0x0001dba9;
platform_get_heap_status = 0x0001dbb1;
platform_get_task_handle = 0x0001dbc9;
...
platform_install_task_stack = 0x0001dc09;
platform_patch_rf_init_data = 0x0001dc41;
platform_printf = 0x0001dc4d;
platform_raise_assertion = 0x0001dc61;
platform_rand = 0x0001dc75;
platform_read_info = 0x0001dc79;
platform_read_persistent_reg = 0x0001dca9;
platform_reset = 0x0001dcb9;
platform_set_evt_callback = 0x0001dcdd;
platform_set_evt_callback_table = 0x0001dcf1;
platform_set_irq_callback = 0x0001dcfd;
platform_set_irq_callback_table = 0x0001dd19;
platform_set_rf_clk_source = 0x0001dd25;
platform_set_rf_init_data = 0x0001dd31;
platform_set_rf_power_mapping = 0x0001dd3d;
platform_set_timer = 0x0001dd49;
platform_shutdown = 0x0001dd4d;
platform_switch_app = 0x0001dd51;
platform_trace_raw = 0x0001dd7d;
platform_write_persistent_reg = 0x0001dd95;
printf_hexdump = 0x0001df49;
pvPortMalloc = 0x0001ea39;
pvTaskIncrementMutexHeldCount = 0x0001eb21;
pvTimerGetTimerID = 0x0001eb39;
pxPortInitialiseStack = 0x0001eb65;
reverse_128 = 0x0001ed0d;
reverse_24 = 0x0001ed13;
reverse_48 = 0x0001ed19;
reverse_56 = 0x0001ed1f;
reverse_64 = 0x0001ed25;
reverse_bd_addr = 0x0001ed2b;
reverse_bytes = 0x0001ed31;
sm_add_event_handler = 0x0001eebd;
sm_address_resolution_lookup = 0x0001f015;
sm_authenticated = 0x0001f375;
sm_authorization_decline = 0x0001f383;
sm_authorization_grant = 0x0001f3a3;
sm_authorization_state = 0x0001f3c3;
sm_bonding_decline = 0x0001f3dd;
sm_config = 0x0001f7fd;
sm_config_conn = 0x0001f815;
sm_encryption_key_size = 0x0001f9cb;
sm_just_works_confirm = 0x0001ff05;
sm_le_device_key = 0x00020241;
sm_passkey_input = 0x000202d7;
sm_private_random_address_generation_get = 0x00020685;
sm_private_random_address_generation_get_mode = 0x0002068d;
sm_private_random_address_generation_set_mode = 0x00020699;
sm_private_random_address_generation_set_update_period = 0x000206c1;
sm_register_oob_data_callback = 0x000207fd;
sm_request_pairing = 0x00020809;
sm_send_security_request = 0x00021243;
sm_set_accepted_stk_generation_methods = 0x00021269;
sm_set_authentication_requirements = 0x00021275;
sm_set_encryption_key_size_range = 0x00021281;
sscanf_bd_addr = 0x00021651;
sysSetPublicDeviceAddr = 0x00021a05;
uuid128_to_str = 0x00021fe5;
uuid_add_bluetooth_prefix = 0x0002203d;
uuid_has_bluetooth_prefix = 0x0002205d;
uxListRemove = 0x00022079;
uxQueueMessagesWaiting = 0x000220a1;
uxQueueMessagesWaitingFromISR = 0x000220c9;
uxQueueSpacesAvailable = 0x000220e5;
uxTaskGetStackHighWaterMark = 0x00022111;
uxTaskPriorityGet = 0x00022131;
uxTaskPriorityGetFromISR = 0x0002214d;
vListInitialise = 0x00022207;
vListInitialiseItem = 0x0002221d;
vListInsert = 0x00022223;
vListInsertEnd = 0x00022253;
vPortEndScheduler = 0x0002226d;
vPortEnterCritical = 0x00022299;
vPortExitCritical = 0x000222dd;
vPortFree = 0x00022311;
vPortSuppressTicksAndSleep = 0x000223a5;
vPortValidateInterruptPriority = 0x000224c1;
vQueueDelete = 0x0002251d;
vQueueWaitForMessageRestricted = 0x00022549;
vTaskDelay = 0x00022591;
vTaskInternalSetTimeOutState = 0x000225dd;
vTaskMissedYield = 0x000225ed;
vTaskPlaceOnEventList = 0x000225f9;
vTaskPlaceOnEventListRestricted = 0x00022631;
vTaskPriorityDisinheritAfterTimeout = 0x00022671;
vTaskPrioritySet = 0x0002271d;
vTaskResume = 0x000227e5;
vTaskStartScheduler = 0x00022869;
vTaskStepTick = 0x000228f9;
vTaskSuspend = 0x00022929;
vTaskSuspendAll = 0x000229e5;
vTaskSwitchContext = 0x000229f5;
xPortStartScheduler = 0x00022a9d;
...
xTimerGetTimerDaemonTaskHandle = 0x00023cd9;
