...
/**
 * @brief ADC calibration manually of single-end mode
 * @note Please get two ADC data in two voltage value, 
 * value 100mV < V1 < 1000mV, 2500mV < V2 < 3200mV are recommend.
 * These two ADC data is Cout1 and Cout2.
 *
 * @param[in] V1              input votage-1 in mV, like V1 = 300 in 0.3V
 * @param[in] V2              votage-2, like 3.0V and V2 = 3000
 * @param[in] Vp              positive referenced voltage in mV
 * @param[in] Cout1           ADC data of V1 voltige
 * @param[in] Cout2           ADC data of V2 voltige
 */
