...
--define_symbol ll_free=0x0000cb41
--define_symbol ll_hint_on_ce_len=0x0000cb4d
--define_symbol ll_legacy_adv_set_interval=0x0000cb85
--define_symbol ll_malloc=0x0000cb95
--define_symbol ll_query_timing_info=0x0000cccd
--define_symbol ll_scan_set_fixed_channel=0x0000cd71
--define_symbol ll_set_adv_access_address=0x0000ce85
--define_symbol ll_set_adv_coded_scheme=0x0000ce91
--define_symbol ll_set_conn_coded_scheme=0x0000cec1
--define_symbol ll_set_conn_latency=0x0000ceed
--define_symbol ll_set_conn_tx_power=0x0000cf1d
--define_symbol ll_set_def_antenna=0x0000cf65
--define_symbol ll_set_initiating_coded_scheme=0x0000cf81
--define_symbol ll_set_max_conn_number=0x0000cf8d
--define_symbol nibble_for_char=0x0001cec1
--define_symbol platform_32k_rc_auto_tune=0x0001cf6d
--define_symbol platform_32k_rc_tune=0x0001cfe9
--define_symbol platform_calibrate_32k=0x0001cffd
--define_symbol platform_config=0x0001d001
--define_symbol platform_enable_irq=0x0001d129
--define_symbol platform_get_current_task=0x0001d161
--define_symbol platform_get_gen_os_driver=0x0001d185
--define_symbol platform_get_heap_status=0x0001d18d
--define_symbol platform_get_task_handle=0x0001d1a5
--define_symbol platform_get_us_time=0x0001d1c5
--define_symbol platform_get_version=0x0001d1c9
--define_symbol platform_hrng=0x0001d1d1
--define_symbol platform_install_isr_stack=0x0001d1d9
--define_symbol platform_install_task_stack=0x0001d1e5
--define_symbol platform_patch_rf_init_data=0x0001d21d
--define_symbol platform_printf=0x0001d229
--define_symbol platform_raise_assertion=0x0001d23d
--define_symbol platform_rand=0x0001d251
--define_symbol platform_read_info=0x0001d255
--define_symbol platform_read_persistent_reg=0x0001d285
--define_symbol platform_reset=0x0001d295
--define_symbol platform_set_evt_callback=0x0001d2b9
--define_symbol platform_set_evt_callback_table=0x0001d2cd
--define_symbol platform_set_irq_callback=0x0001d2d9
--define_symbol platform_set_irq_callback_table=0x0001d2f5
--define_symbol platform_set_rf_clk_source=0x0001d301
--define_symbol platform_set_rf_init_data=0x0001d30d
--define_symbol platform_set_rf_power_mapping=0x0001d319
--define_symbol platform_set_timer=0x0001d325
--define_symbol platform_shutdown=0x0001d329
--define_symbol platform_switch_app=0x0001d32d
--define_symbol platform_trace_raw=0x0001d359
--define_symbol platform_write_persistent_reg=0x0001d371
--define_symbol printf_hexdump=0x0001d525
--define_symbol pvPortMalloc=0x0001e015
--define_symbol pvTaskIncrementMutexHeldCount=0x0001e0fd
--define_symbol pvTimerGetTimerID=0x0001e115
--define_symbol pxPortInitialiseStack=0x0001e141
--define_symbol reverse_128=0x0001e2e9
--define_symbol reverse_24=0x0001e2ef
--define_symbol reverse_48=0x0001e2f5
--define_symbol reverse_56=0x0001e2fb
--define_symbol reverse_64=0x0001e301
--define_symbol reverse_bd_addr=0x0001e307
--define_symbol reverse_bytes=0x0001e30d
--define_symbol sm_add_event_handler=0x0001e479
--define_symbol sm_address_resolution_lookup=0x0001e5d1
--define_symbol sm_authenticated=0x0001e931
--define_symbol sm_authorization_decline=0x0001e93f
--define_symbol sm_authorization_grant=0x0001e95f
--define_symbol sm_authorization_state=0x0001e97f
--define_symbol sm_bonding_decline=0x0001e999
--define_symbol sm_config=0x0001edb9
--define_symbol sm_config_conn=0x0001edd1
--define_symbol sm_encryption_key_size=0x0001ef87
--define_symbol sm_just_works_confirm=0x0001f4c1
--define_symbol sm_le_device_key=0x0001f7fd
--define_symbol sm_passkey_input=0x0001f893
--define_symbol sm_private_random_address_generation_get=0x0001fc41
--define_symbol sm_private_random_address_generation_get_mode=0x0001fc49
--define_symbol sm_private_random_address_generation_set_mode=0x0001fc55
--define_symbol sm_private_random_address_generation_set_update_period=0x0001fc7d
--define_symbol sm_register_oob_data_callback=0x0001fdb9
--define_symbol sm_request_pairing=0x0001fdc5
--define_symbol sm_send_security_request=0x000207ff
--define_symbol sm_set_accepted_stk_generation_methods=0x00020825
--define_symbol sm_set_authentication_requirements=0x00020831
--define_symbol sm_set_encryption_key_size_range=0x0002083d
--define_symbol sscanf_bd_addr=0x00020b99
--define_symbol sysSetPublicDeviceAddr=0x00020f4d
--define_symbol uuid128_to_str=0x0002152d
--define_symbol uuid_add_bluetooth_prefix=0x00021585
--define_symbol uuid_has_bluetooth_prefix=0x000215a5
--define_symbol uxListRemove=0x000215c1
--define_symbol uxQueueMessagesWaiting=0x000215e9
--define_symbol uxQueueMessagesWaitingFromISR=0x00021611
--define_symbol uxQueueSpacesAvailable=0x0002162d
--define_symbol uxTaskGetStackHighWaterMark=0x00021659
--define_symbol uxTaskPriorityGet=0x00021679
--define_symbol uxTaskPriorityGetFromISR=0x00021695
--define_symbol vListInitialise=0x0002174f
--define_symbol vListInitialiseItem=0x00021765
--define_symbol vListInsert=0x0002176b
--define_symbol vListInsertEnd=0x0002179b
--define_symbol vPortEndScheduler=0x000217b5
--define_symbol vPortEnterCritical=0x000217e1
--define_symbol vPortExitCritical=0x00021825
--define_symbol vPortFree=0x00021859
--define_symbol vPortSuppressTicksAndSleep=0x000218ed
--define_symbol vPortValidateInterruptPriority=0x00021a09
--define_symbol vQueueDelete=0x00021a65
--define_symbol vQueueWaitForMessageRestricted=0x00021a91
--define_symbol vTaskDelay=0x00021ad9
--define_symbol vTaskInternalSetTimeOutState=0x00021b25
--define_symbol vTaskMissedYield=0x00021b35
--define_symbol vTaskPlaceOnEventList=0x00021b41
--define_symbol vTaskPlaceOnEventListRestricted=0x00021b79
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00021bb9
--define_symbol vTaskPrioritySet=0x00021c65
--define_symbol vTaskResume=0x00021d2d
--define_symbol vTaskStartScheduler=0x00021db1
--define_symbol vTaskStepTick=0x00021e41
--define_symbol vTaskSuspend=0x00021e71
--define_symbol vTaskSuspendAll=0x00021f2d
--define_symbol vTaskSwitchContext=0x00021f3d
--define_symbol xPortStartScheduler=0x00021fe5
--define_symbol xQueueAddToSet=0x000220ad
--define_symbol xQueueCreateCountingSemaphore=0x000220d1
--define_symbol xQueueCreateCountingSemaphoreStatic=0x0002210d
--define_symbol xQueueCreateMutex=0x00022151
--define_symbol xQueueCreateMutexStatic=0x00022167
--define_symbol xQueueCreateSet=0x00022181
--define_symbol xQueueGenericCreate=0x00022189
--define_symbol xQueueGenericCreateStatic=0x000221d5
--define_symbol xQueueGenericReset=0x0002223d
--define_symbol xQueueGenericSend=0x000222c9
--define_symbol xQueueGenericSendFromISR=0x00022435
--define_symbol xQueueGiveFromISR=0x000224f5
--define_symbol xQueueGiveMutexRecursive=0x00022599
--define_symbol xQueueIsQueueEmptyFromISR=0x000225d9
--define_symbol xQueueIsQueueFullFromISR=0x000225fd
--define_symbol xQueuePeek=0x00022625
--define_symbol xQueuePeekFromISR=0x0002274d
--define_symbol xQueueReceive=0x000227b9
--define_symbol xQueueReceiveFromISR=0x000228e5
--define_symbol xQueueRemoveFromSet=0x00022979
--define_symbol xQueueSelectFromSet=0x0002299b
--define_symbol xQueueSelectFromSetFromISR=0x000229ad
--define_symbol xQueueSemaphoreTake=0x000229c1
--define_symbol xQueueTakeMutexRecursive=0x00022b2d
--define_symbol xTaskCheckForTimeOut=0x00022b71
--define_symbol xTaskCreate=0x00022be1
--define_symbol xTaskCreateStatic=0x00022c3d
--define_symbol xTaskGetCurrentTaskHandle=0x00022cad
--define_symbol xTaskGetSchedulerState=0x00022cb9
--define_symbol xTaskGetTickCount=0x00022cd5
--define_symbol xTaskGetTickCountFromISR=0x00022ce1
--define_symbol xTaskIncrementTick=0x00022cf1
--define_symbol xTaskPriorityDisinherit=0x00022dbd
--define_symbol xTaskPriorityInherit=0x00022e51
--define_symbol xTaskRemoveFromEventList=0x00022ee5
--define_symbol xTaskResumeAll=0x00022f65
--define_symbol xTaskResumeFromISR=0x0002302d
--define_symbol xTimerCreate=0x000230b9
--define_symbol xTimerCreateStatic=0x000230ed
--define_symbol xTimerCreateTimerTask=0x00023125
--define_symbol xTimerGenericCommand=0x00023191
--define_symbol xTimerGetExpiryTime=0x00023201
--define_symbol xTimerGetTimerDaemonTaskHandle=0x00023221
