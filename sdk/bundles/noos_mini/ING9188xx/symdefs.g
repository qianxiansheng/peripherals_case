...
platform_controller_run = 0x0001e095;
platform_enable_irq = 0x0001e0cd;
platform_get_gen_os_driver = 0x0001e105;
platform_get_task_handle = 0x0001e111;
platform_get_us_time = 0x0001e129;
platform_get_version = 0x0001e12d;
platform_hrng = 0x0001e135;
platform_init_controller = 0x0001e13d;
platform_os_idle_resumed_hook = 0x0001e159;
platform_patch_rf_init_data = 0x0001e15d;
platform_post_sleep_processing = 0x0001e169;
platform_pre_sleep_processing = 0x0001e16f;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001e175;
platform_printf = 0x0001e179;
platform_raise_assertion = 0x0001e18d;
platform_rand = 0x0001e1a1;
platform_read_info = 0x0001e1a5;
platform_read_persistent_reg = 0x0001e1d5;
platform_reset = 0x0001e1e5;
platform_set_evt_callback = 0x0001e209;
platform_set_evt_callback_table = 0x0001e21d;
platform_set_irq_callback = 0x0001e229;
platform_set_irq_callback_table = 0x0001e245;
platform_set_rf_clk_source = 0x0001e251;
platform_set_rf_init_data = 0x0001e25d;
platform_set_rf_power_mapping = 0x0001e269;
platform_set_timer = 0x0001e275;
platform_shutdown = 0x0001e279;
platform_switch_app = 0x0001e27d;
platform_trace_raw = 0x0001e2a9;
platform_write_persistent_reg = 0x0001e2c1;
printf_hexdump = 0x0001e2d1;
...
sm_add_event_handler = 0x0001e921;
sm_address_resolution_lookup = 0x0001ea79;
sm_authenticated = 0x0001edd9;
sm_authorization_decline = 0x0001ede7;
sm_authorization_grant = 0x0001ee07;
sm_authorization_state = 0x0001ee27;
sm_bonding_decline = 0x0001ee41;
sm_config = 0x0001f261;
sm_config_conn = 0x0001f279;
sm_encryption_key_size = 0x0001f42f;
sm_just_works_confirm = 0x0001f969;
sm_le_device_key = 0x0001fca5;
sm_passkey_input = 0x0001fd3b;
sm_private_random_address_generation_get = 0x000200e9;
sm_private_random_address_generation_get_mode = 0x000200f1;
sm_private_random_address_generation_set_mode = 0x000200fd;
sm_private_random_address_generation_set_update_period = 0x00020125;
sm_register_oob_data_callback = 0x00020261;
sm_request_pairing = 0x0002026d;
sm_send_security_request = 0x00020ca7;
sm_set_accepted_stk_generation_methods = 0x00020ccd;
sm_set_authentication_requirements = 0x00020cd9;
sm_set_encryption_key_size_range = 0x00020ce5;
sscanf_bd_addr = 0x00021041;
sysSetPublicDeviceAddr = 0x000213f5;
uuid128_to_str = 0x00021b6d;
uuid_add_bluetooth_prefix = 0x00021bc5;
uuid_has_bluetooth_prefix = 0x00021be5;
