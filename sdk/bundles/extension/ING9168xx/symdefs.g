...
platform_enable_irq = 0x0201fd61;
platform_get_current_task = 0x0201fd95;
platform_get_gen_os_driver = 0x0201fdb9;
platform_get_heap_status = 0x0201fdc1;
platform_get_task_handle = 0x0201fdd9;
platform_get_us_time = 0x0201fdf9;
platform_get_version = 0x0201fdfd;
platform_hrng = 0x0201fe05;
platform_install_isr_stack = 0x0201fe0d;
platform_install_task_stack = 0x0201fe19;
platform_patch_rf_init_data = 0x0201fe51;
platform_printf = 0x0201fe5d;
platform_raise_assertion = 0x0201fe71;
platform_rand = 0x0201fe85;
platform_read_info = 0x0201fe89;
platform_read_persistent_reg = 0x0201feb9;
platform_reset = 0x0201fec5;
platform_set_evt_callback = 0x0201fed9;
platform_set_evt_callback_table = 0x0201feed;
platform_set_irq_callback = 0x0201fef9;
platform_set_irq_callback_table = 0x0201ff15;
platform_set_rf_clk_source = 0x0201ff21;
platform_set_rf_init_data = 0x0201ff2d;
platform_set_rf_power_mapping = 0x0201ff39;
platform_set_timer = 0x0201ff45;
platform_shutdown = 0x0201ff49;
platform_switch_app = 0x0201ff4d;
platform_trace_raw = 0x0201ff65;
platform_write_persistent_reg = 0x0201ff7d;
printf_hexdump = 0x02020135;
pvPortMalloc = 0x02020c09;
pvTaskIncrementMutexHeldCount = 0x02020cf1;
pvTimerGetTimerID = 0x02020d09;
pxPortInitialiseStack = 0x02020d35;
reverse_128 = 0x02020f1d;
reverse_24 = 0x02020f23;
reverse_48 = 0x02020f29;
reverse_56 = 0x02020f2f;
reverse_64 = 0x02020f35;
reverse_bd_addr = 0x02020f3b;
reverse_bytes = 0x02020f41;
sm_add_event_handler = 0x0202127d;
sm_address_resolution_lookup = 0x020213d5;
sm_authenticated = 0x02021735;
sm_authorization_decline = 0x02021743;
sm_authorization_grant = 0x02021763;
sm_authorization_state = 0x02021783;
sm_bonding_decline = 0x0202179d;
sm_config = 0x02021bb5;
sm_config_conn = 0x02021bcd;
sm_encryption_key_size = 0x02021d83;
sm_just_works_confirm = 0x020222bd;
sm_le_device_key = 0x020225f9;
sm_passkey_input = 0x0202268f;
sm_private_random_address_generation_get = 0x02022a3d;
sm_private_random_address_generation_get_mode = 0x02022a45;
sm_private_random_address_generation_set_mode = 0x02022a51;
sm_private_random_address_generation_set_update_period = 0x02022a79;
sm_register_oob_data_callback = 0x02022bb5;
sm_request_pairing = 0x02022bc1;
sm_send_security_request = 0x020235ff;
sm_set_accepted_stk_generation_methods = 0x02023625;
sm_set_authentication_requirements = 0x02023631;
sm_set_encryption_key_size_range = 0x0202363d;
sscanf_bd_addr = 0x02023a15;
sysSetPublicDeviceAddr = 0x02023e81;
uuid128_to_str = 0x0202462d;
uuid_add_bluetooth_prefix = 0x02024685;
uuid_has_bluetooth_prefix = 0x020246a5;
uxListRemove = 0x020246c1;
uxQueueMessagesWaiting = 0x020246e9;
uxQueueMessagesWaitingFromISR = 0x02024711;
uxQueueSpacesAvailable = 0x0202472d;
uxTaskGetStackHighWaterMark = 0x02024759;
uxTaskPriorityGet = 0x02024779;
uxTaskPriorityGetFromISR = 0x02024795;
vListInitialise = 0x0202483b;
vListInitialiseItem = 0x02024851;
vListInsert = 0x02024857;
vListInsertEnd = 0x02024887;
vPortEndScheduler = 0x020248a1;
vPortEnterCritical = 0x020248cd;
vPortExitCritical = 0x02024911;
vPortFree = 0x02024945;
vPortSuppressTicksAndSleep = 0x020249e9;
vPortValidateInterruptPriority = 0x02024b11;
vQueueDelete = 0x02024b6d;
vQueueWaitForMessageRestricted = 0x02024b99;
vTaskDelay = 0x02024bdd;
vTaskInternalSetTimeOutState = 0x02024c29;
vTaskMissedYield = 0x02024c39;
vTaskPlaceOnEventList = 0x02024c45;
vTaskPlaceOnEventListRestricted = 0x02024c7d;
vTaskPriorityDisinheritAfterTimeout = 0x02024cbd;
vTaskPrioritySet = 0x02024d69;
vTaskResume = 0x02024e31;
vTaskStartScheduler = 0x02024eb5;
vTaskStepTick = 0x02024f45;
vTaskSuspend = 0x02024f75;
vTaskSuspendAll = 0x02025031;
vTaskSwitchContext = 0x02025041;
xPortStartScheduler = 0x020250e9;
xQueueAddToSet = 0x020251ed;
xQueueCreateCountingSemaphore = 0x02025211;
xQueueCreateCountingSemaphoreStatic = 0x0202524d;
xQueueCreateMutex = 0x02025291;
xQueueCreateMutexStatic = 0x020252a7;
xQueueCreateSet = 0x020252c1;
xQueueGenericCreate = 0x020252c9;
xQueueGenericCreateStatic = 0x02025315;
xQueueGenericReset = 0x0202537d;
xQueueGenericSend = 0x02025409;
xQueueGenericSendFromISR = 0x02025575;
xQueueGiveFromISR = 0x02025635;
xQueueGiveMutexRecursive = 0x020256d9;
xQueueIsQueueEmptyFromISR = 0x02025719;
xQueueIsQueueFullFromISR = 0x0202573d;
xQueuePeek = 0x02025765;
xQueuePeekFromISR = 0x0202588d;
xQueueReceive = 0x020258f9;
xQueueReceiveFromISR = 0x02025a25;
xQueueRemoveFromSet = 0x02025ab9;
xQueueSelectFromSet = 0x02025adb;
xQueueSelectFromSetFromISR = 0x02025aed;
xQueueSemaphoreTake = 0x02025b01;
xQueueTakeMutexRecursive = 0x02025c6d;
xTaskCheckForTimeOut = 0x02025cb1;
xTaskCreate = 0x02025d21;
xTaskCreateStatic = 0x02025d7d;
xTaskGetCurrentTaskHandle = 0x02025ded;
xTaskGetSchedulerState = 0x02025df9;
xTaskGetTickCount = 0x02025e15;
xTaskGetTickCountFromISR = 0x02025e21;
xTaskIncrementTick = 0x02025e31;
xTaskPriorityDisinherit = 0x02025efd;
xTaskPriorityInherit = 0x02025f91;
xTaskRemoveFromEventList = 0x02026025;
xTaskResumeAll = 0x020260a5;
xTaskResumeFromISR = 0x0202616d;
xTimerCreate = 0x020261f9;
xTimerCreateStatic = 0x0202622d;
xTimerCreateTimerTask = 0x02026265;
xTimerGenericCommand = 0x020262d1;
xTimerGetExpiryTime = 0x02026341;
xTimerGetTimerDaemonTaskHandle = 0x02026361;
