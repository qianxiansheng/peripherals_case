...
platform_controller_run = 0x0001e2a9;
platform_enable_irq = 0x0001e2e1;
platform_get_gen_os_driver = 0x0001e319;
platform_get_task_handle = 0x0001e325;
platform_get_us_time = 0x0001e33d;
platform_get_version = 0x0001e341;
platform_hrng = 0x0001e349;
platform_init_controller = 0x0001e351;
platform_os_idle_resumed_hook = 0x0001e36d;
platform_patch_rf_init_data = 0x0001e371;
platform_post_sleep_processing = 0x0001e37d;
platform_pre_sleep_processing = 0x0001e383;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001e389;
platform_printf = 0x0001e38d;
platform_raise_assertion = 0x0001e3a1;
platform_rand = 0x0001e3b5;
platform_read_info = 0x0001e3b9;
platform_read_persistent_reg = 0x0001e3e9;
platform_reset = 0x0001e3f9;
platform_set_evt_callback = 0x0001e41d;
platform_set_evt_callback_table = 0x0001e431;
platform_set_irq_callback = 0x0001e43d;
platform_set_irq_callback_table = 0x0001e459;
platform_set_rf_clk_source = 0x0001e465;
platform_set_rf_init_data = 0x0001e471;
platform_set_rf_power_mapping = 0x0001e47d;
platform_set_timer = 0x0001e489;
platform_shutdown = 0x0001e48d;
platform_switch_app = 0x0001e491;
platform_trace_raw = 0x0001e4bd;
platform_write_persistent_reg = 0x0001e4d5;
printf_hexdump = 0x0001e4e5;
reverse_128 = 0x0001e859;
reverse_24 = 0x0001e85f;
reverse_48 = 0x0001e865;
reverse_56 = 0x0001e86b;
reverse_64 = 0x0001e871;
reverse_bd_addr = 0x0001e877;
reverse_bytes = 0x0001e87d;
sm_add_event_handler = 0x0001eb3d;
sm_address_resolution_lookup = 0x0001ec95;
...
sm_just_works_confirm = 0x0001fb85;
sm_le_device_key = 0x0001fec1;
sm_passkey_input = 0x0001ff57;
sm_private_random_address_generation_get = 0x00020305;
sm_private_random_address_generation_get_mode = 0x0002030d;
sm_private_random_address_generation_set_mode = 0x00020319;
sm_private_random_address_generation_set_update_period = 0x00020341;
sm_register_oob_data_callback = 0x0002047d;
sm_request_pairing = 0x00020489;
sm_send_security_request = 0x00020ec3;
sm_set_accepted_stk_generation_methods = 0x00020ee9;
sm_set_authentication_requirements = 0x00020ef5;
sm_set_encryption_key_size_range = 0x00020f01;
sscanf_bd_addr = 0x0002125d;
sysSetPublicDeviceAddr = 0x00021611;
