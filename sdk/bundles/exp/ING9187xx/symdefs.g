...
platform_enable_irq = 0x0001f68d;
platform_get_current_task = 0x0001f6c5;
platform_get_gen_os_driver = 0x0001f6e9;
platform_get_heap_status = 0x0001f6f1;
platform_get_task_handle = 0x0001f709;
platform_get_us_time = 0x0001f729;
platform_get_version = 0x0001f72d;
platform_hrng = 0x0001f735;
platform_install_isr_stack = 0x0001f73d;
platform_install_task_stack = 0x0001f749;
platform_patch_rf_init_data = 0x0001f781;
platform_printf = 0x0001f78d;
platform_raise_assertion = 0x0001f7a1;
platform_rand = 0x0001f7b5;
platform_read_info = 0x0001f7b9;
platform_read_persistent_reg = 0x0001f7e9;
platform_reset = 0x0001f7f9;
platform_set_evt_callback = 0x0001f81d;
platform_set_evt_callback_table = 0x0001f831;
platform_set_irq_callback = 0x0001f83d;
platform_set_irq_callback_table = 0x0001f859;
platform_set_rf_clk_source = 0x0001f865;
platform_set_rf_init_data = 0x0001f871;
platform_set_rf_power_mapping = 0x0001f87d;
platform_set_timer = 0x0001f889;
platform_shutdown = 0x0001f88d;
platform_switch_app = 0x0001f891;
platform_trace_raw = 0x0001f8bd;
platform_write_persistent_reg = 0x0001f8d5;
printf_hexdump = 0x0001fa89;
pvPortMalloc = 0x00020579;
pvTaskIncrementMutexHeldCount = 0x00020661;
pvTimerGetTimerID = 0x00020679;
pxPortInitialiseStack = 0x000206a5;
reverse_128 = 0x0002084d;
reverse_24 = 0x00020853;
reverse_48 = 0x00020859;
reverse_56 = 0x0002085f;
reverse_64 = 0x00020865;
reverse_bd_addr = 0x0002086b;
reverse_bytes = 0x00020871;
sm_add_event_handler = 0x00020a1d;
sm_address_resolution_lookup = 0x00020b75;
sm_authenticated = 0x00020ed5;
sm_authorization_decline = 0x00020ee3;
sm_authorization_grant = 0x00020f03;
sm_authorization_state = 0x00020f23;
sm_bonding_decline = 0x00020f3d;
sm_config = 0x0002135d;
sm_config_conn = 0x00021375;
sm_encryption_key_size = 0x0002152b;
sm_just_works_confirm = 0x00021a65;
sm_le_device_key = 0x00021da1;
sm_passkey_input = 0x00021e37;
sm_private_random_address_generation_get = 0x000221e5;
sm_private_random_address_generation_get_mode = 0x000221ed;
sm_private_random_address_generation_set_mode = 0x000221f9;
sm_private_random_address_generation_set_update_period = 0x00022221;
sm_register_oob_data_callback = 0x0002235d;
sm_request_pairing = 0x00022369;
sm_send_security_request = 0x00022da3;
sm_set_accepted_stk_generation_methods = 0x00022dc9;
sm_set_authentication_requirements = 0x00022dd5;
sm_set_encryption_key_size_range = 0x00022de1;
sscanf_bd_addr = 0x000231b1;
sysSetPublicDeviceAddr = 0x00023565;
uuid128_to_str = 0x00023b6d;
uuid_add_bluetooth_prefix = 0x00023bc5;
uuid_has_bluetooth_prefix = 0x00023be5;
uxListRemove = 0x00023c01;
uxQueueMessagesWaiting = 0x00023c29;
uxQueueMessagesWaitingFromISR = 0x00023c51;
uxQueueSpacesAvailable = 0x00023c6d;
uxTaskGetStackHighWaterMark = 0x00023c99;
uxTaskPriorityGet = 0x00023cb9;
uxTaskPriorityGetFromISR = 0x00023cd5;
vListInitialise = 0x00023d8f;
vListInitialiseItem = 0x00023da5;
vListInsert = 0x00023dab;
vListInsertEnd = 0x00023ddb;
vPortEndScheduler = 0x00023df5;
vPortEnterCritical = 0x00023e21;
vPortExitCritical = 0x00023e65;
vPortFree = 0x00023e99;
vPortSuppressTicksAndSleep = 0x00023f2d;
vPortValidateInterruptPriority = 0x00024049;
vQueueDelete = 0x000240a5;
vQueueWaitForMessageRestricted = 0x000240d1;
vTaskDelay = 0x00024119;
vTaskInternalSetTimeOutState = 0x00024165;
vTaskMissedYield = 0x00024175;
vTaskPlaceOnEventList = 0x00024181;
vTaskPlaceOnEventListRestricted = 0x000241b9;
vTaskPriorityDisinheritAfterTimeout = 0x000241f9;
vTaskPrioritySet = 0x000242a5;
vTaskResume = 0x0002436d;
vTaskStartScheduler = 0x000243f1;
vTaskStepTick = 0x00024481;
vTaskSuspend = 0x000244b1;
vTaskSuspendAll = 0x0002456d;
vTaskSwitchContext = 0x0002457d;
xPortStartScheduler = 0x00024625;
xQueueAddToSet = 0x000246ed;
xQueueCreateCountingSemaphore = 0x00024711;
xQueueCreateCountingSemaphoreStatic = 0x0002474d;
xQueueCreateMutex = 0x00024791;
xQueueCreateMutexStatic = 0x000247a7;
xQueueCreateSet = 0x000247c1;
xQueueGenericCreate = 0x000247c9;
xQueueGenericCreateStatic = 0x00024815;
xQueueGenericReset = 0x0002487d;
xQueueGenericSend = 0x00024909;
xQueueGenericSendFromISR = 0x00024a75;
xQueueGiveFromISR = 0x00024b35;
xQueueGiveMutexRecursive = 0x00024bd9;
xQueueIsQueueEmptyFromISR = 0x00024c19;
xQueueIsQueueFullFromISR = 0x00024c3d;
xQueuePeek = 0x00024c65;
xQueuePeekFromISR = 0x00024d8d;
xQueueReceive = 0x00024df9;
xQueueReceiveFromISR = 0x00024f25;
xQueueRemoveFromSet = 0x00024fb9;
xQueueSelectFromSet = 0x00024fdb;
xQueueSelectFromSetFromISR = 0x00024fed;
xQueueSemaphoreTake = 0x00025001;
xQueueTakeMutexRecursive = 0x0002516d;
xTaskCheckForTimeOut = 0x000251b1;
xTaskCreate = 0x00025221;
xTaskCreateStatic = 0x0002527d;
xTaskGetCurrentTaskHandle = 0x000252ed;
xTaskGetSchedulerState = 0x000252f9;
xTaskGetTickCount = 0x00025315;
xTaskGetTickCountFromISR = 0x00025321;
xTaskIncrementTick = 0x00025331;
xTaskPriorityDisinherit = 0x000253fd;
xTaskPriorityInherit = 0x00025491;
xTaskRemoveFromEventList = 0x00025525;
xTaskResumeAll = 0x000255a5;
xTaskResumeFromISR = 0x0002566d;
xTimerCreate = 0x000256f9;
xTimerCreateStatic = 0x0002572d;
xTimerCreateTimerTask = 0x00025765;
xTimerGenericCommand = 0x000257d1;
xTimerGetExpiryTime = 0x00025841;
xTimerGetTimerDaemonTaskHandle = 0x00025861;
