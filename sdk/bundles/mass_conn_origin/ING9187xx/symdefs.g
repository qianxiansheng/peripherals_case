...
platform_enable_irq = 0x0001d161;
platform_get_current_task = 0x0001d199;
platform_get_gen_os_driver = 0x0001d1bd;
platform_get_heap_status = 0x0001d1c5;
platform_get_task_handle = 0x0001d1dd;
platform_get_us_time = 0x0001d1fd;
platform_get_version = 0x0001d201;
platform_hrng = 0x0001d209;
platform_install_isr_stack = 0x0001d211;
platform_install_task_stack = 0x0001d21d;
platform_patch_rf_init_data = 0x0001d255;
platform_printf = 0x0001d261;
platform_raise_assertion = 0x0001d275;
platform_rand = 0x0001d289;
platform_read_info = 0x0001d28d;
platform_read_persistent_reg = 0x0001d2bd;
platform_reset = 0x0001d2cd;
platform_set_evt_callback = 0x0001d2f1;
platform_set_evt_callback_table = 0x0001d305;
platform_set_irq_callback = 0x0001d311;
platform_set_irq_callback_table = 0x0001d32d;
platform_set_rf_clk_source = 0x0001d339;
platform_set_rf_init_data = 0x0001d345;
platform_set_rf_power_mapping = 0x0001d351;
platform_set_timer = 0x0001d35d;
...
printf_hexdump = 0x0001d55d;
pvPortMalloc = 0x0001e04d;
pvTaskIncrementMutexHeldCount = 0x0001e135;
pvTimerGetTimerID = 0x0001e14d;
pxPortInitialiseStack = 0x0001e179;
reverse_128 = 0x0001e321;
reverse_24 = 0x0001e327;
reverse_48 = 0x0001e32d;
reverse_56 = 0x0001e333;
reverse_64 = 0x0001e339;
reverse_bd_addr = 0x0001e33f;
reverse_bytes = 0x0001e345;
sm_add_event_handler = 0x0001e4b1;
sm_address_resolution_lookup = 0x0001e609;
sm_authenticated = 0x0001e969;
sm_authorization_decline = 0x0001e977;
sm_authorization_grant = 0x0001e997;
sm_authorization_state = 0x0001e9b7;
sm_bonding_decline = 0x0001e9d1;
sm_config = 0x0001edf1;
sm_config_conn = 0x0001ee09;
sm_encryption_key_size = 0x0001efbf;
sm_just_works_confirm = 0x0001f4f9;
sm_le_device_key = 0x0001f835;
sm_passkey_input = 0x0001f8cb;
sm_private_random_address_generation_get = 0x0001fc79;
sm_private_random_address_generation_get_mode = 0x0001fc81;
sm_private_random_address_generation_set_mode = 0x0001fc8d;
sm_private_random_address_generation_set_update_period = 0x0001fcb5;
sm_register_oob_data_callback = 0x0001fdf1;
sm_request_pairing = 0x0001fdfd;
sm_send_security_request = 0x00020837;
sm_set_accepted_stk_generation_methods = 0x0002085d;
sm_set_authentication_requirements = 0x00020869;
sm_set_encryption_key_size_range = 0x00020875;
sscanf_bd_addr = 0x00020bd1;
sysSetPublicDeviceAddr = 0x00020f85;
uuid128_to_str = 0x00021565;
uuid_add_bluetooth_prefix = 0x000215bd;
uuid_has_bluetooth_prefix = 0x000215dd;
uxListRemove = 0x000215f9;
uxQueueMessagesWaiting = 0x00021621;
uxQueueMessagesWaitingFromISR = 0x00021649;
uxQueueSpacesAvailable = 0x00021665;
uxTaskGetStackHighWaterMark = 0x00021691;
uxTaskPriorityGet = 0x000216b1;
uxTaskPriorityGetFromISR = 0x000216cd;
vListInitialise = 0x00021787;
vListInitialiseItem = 0x0002179d;
vListInsert = 0x000217a3;
vListInsertEnd = 0x000217d3;
vPortEndScheduler = 0x000217ed;
vPortEnterCritical = 0x00021819;
vPortExitCritical = 0x0002185d;
vPortFree = 0x00021891;
vPortSuppressTicksAndSleep = 0x00021925;
vPortValidateInterruptPriority = 0x00021a41;
vQueueDelete = 0x00021a9d;
vQueueWaitForMessageRestricted = 0x00021ac9;
vTaskDelay = 0x00021b11;
vTaskInternalSetTimeOutState = 0x00021b5d;
vTaskMissedYield = 0x00021b6d;
vTaskPlaceOnEventList = 0x00021b79;
vTaskPlaceOnEventListRestricted = 0x00021bb1;
vTaskPriorityDisinheritAfterTimeout = 0x00021bf1;
vTaskPrioritySet = 0x00021c9d;
vTaskResume = 0x00021d65;
vTaskStartScheduler = 0x00021de9;
vTaskStepTick = 0x00021e79;
vTaskSuspend = 0x00021ea9;
vTaskSuspendAll = 0x00021f65;
vTaskSwitchContext = 0x00021f75;
xPortStartScheduler = 0x0002201d;
xQueueAddToSet = 0x000220e5;
xQueueCreateCountingSemaphore = 0x00022109;
xQueueCreateCountingSemaphoreStatic = 0x00022145;
xQueueCreateMutex = 0x00022189;
xQueueCreateMutexStatic = 0x0002219f;
xQueueCreateSet = 0x000221b9;
xQueueGenericCreate = 0x000221c1;
xQueueGenericCreateStatic = 0x0002220d;
xQueueGenericReset = 0x00022275;
xQueueGenericSend = 0x00022301;
xQueueGenericSendFromISR = 0x0002246d;
xQueueGiveFromISR = 0x0002252d;
xQueueGiveMutexRecursive = 0x000225d1;
xQueueIsQueueEmptyFromISR = 0x00022611;
xQueueIsQueueFullFromISR = 0x00022635;
xQueuePeek = 0x0002265d;
xQueuePeekFromISR = 0x00022785;
xQueueReceive = 0x000227f1;
xQueueReceiveFromISR = 0x0002291d;
xQueueRemoveFromSet = 0x000229b1;
xQueueSelectFromSet = 0x000229d3;
xQueueSelectFromSetFromISR = 0x000229e5;
xQueueSemaphoreTake = 0x000229f9;
xQueueTakeMutexRecursive = 0x00022b65;
xTaskCheckForTimeOut = 0x00022ba9;
xTaskCreate = 0x00022c19;
xTaskCreateStatic = 0x00022c75;
xTaskGetCurrentTaskHandle = 0x00022ce5;
xTaskGetSchedulerState = 0x00022cf1;
xTaskGetTickCount = 0x00022d0d;
xTaskGetTickCountFromISR = 0x00022d19;
xTaskIncrementTick = 0x00022d29;
xTaskPriorityDisinherit = 0x00022df5;
xTaskPriorityInherit = 0x00022e89;
xTaskRemoveFromEventList = 0x00022f1d;
xTaskResumeAll = 0x00022f9d;
xTaskResumeFromISR = 0x00023065;
xTimerCreate = 0x000230f1;
xTimerCreateStatic = 0x00023125;
xTimerCreateTimerTask = 0x0002315d;
xTimerGenericCommand = 0x000231c9;
xTimerGetExpiryTime = 0x00023239;
xTimerGetTimerDaemonTaskHandle = 0x00023259;
