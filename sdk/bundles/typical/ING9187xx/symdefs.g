...
platform_enable_irq = 0x0001d129;
platform_get_current_task = 0x0001d161;
platform_get_gen_os_driver = 0x0001d185;
platform_get_heap_status = 0x0001d18d;
platform_get_task_handle = 0x0001d1a5;
platform_get_us_time = 0x0001d1c5;
platform_get_version = 0x0001d1c9;
platform_hrng = 0x0001d1d1;
platform_install_isr_stack = 0x0001d1d9;
platform_install_task_stack = 0x0001d1e5;
platform_patch_rf_init_data = 0x0001d21d;
platform_printf = 0x0001d229;
platform_raise_assertion = 0x0001d23d;
platform_rand = 0x0001d251;
platform_read_info = 0x0001d255;
platform_read_persistent_reg = 0x0001d285;
platform_reset = 0x0001d295;
platform_set_evt_callback = 0x0001d2b9;
platform_set_evt_callback_table = 0x0001d2cd;
platform_set_irq_callback = 0x0001d2d9;
platform_set_irq_callback_table = 0x0001d2f5;
platform_set_rf_clk_source = 0x0001d301;
platform_set_rf_init_data = 0x0001d30d;
platform_set_rf_power_mapping = 0x0001d319;
platform_set_timer = 0x0001d325;
platform_shutdown = 0x0001d329;
platform_switch_app = 0x0001d32d;
platform_trace_raw = 0x0001d359;
platform_write_persistent_reg = 0x0001d371;
printf_hexdump = 0x0001d525;
pvPortMalloc = 0x0001e015;
pvTaskIncrementMutexHeldCount = 0x0001e0fd;
pvTimerGetTimerID = 0x0001e115;
pxPortInitialiseStack = 0x0001e141;
reverse_128 = 0x0001e2e9;
reverse_24 = 0x0001e2ef;
reverse_48 = 0x0001e2f5;
reverse_56 = 0x0001e2fb;
reverse_64 = 0x0001e301;
reverse_bd_addr = 0x0001e307;
reverse_bytes = 0x0001e30d;
sm_add_event_handler = 0x0001e479;
sm_address_resolution_lookup = 0x0001e5d1;
sm_authenticated = 0x0001e931;
sm_authorization_decline = 0x0001e93f;
sm_authorization_grant = 0x0001e95f;
sm_authorization_state = 0x0001e97f;
sm_bonding_decline = 0x0001e999;
sm_config = 0x0001edb9;
sm_config_conn = 0x0001edd1;
sm_encryption_key_size = 0x0001ef87;
sm_just_works_confirm = 0x0001f4c1;
sm_le_device_key = 0x0001f7fd;
sm_passkey_input = 0x0001f893;
sm_private_random_address_generation_get = 0x0001fc41;
sm_private_random_address_generation_get_mode = 0x0001fc49;
sm_private_random_address_generation_set_mode = 0x0001fc55;
sm_private_random_address_generation_set_update_period = 0x0001fc7d;
sm_register_oob_data_callback = 0x0001fdb9;
sm_request_pairing = 0x0001fdc5;
sm_send_security_request = 0x000207ff;
sm_set_accepted_stk_generation_methods = 0x00020825;
sm_set_authentication_requirements = 0x00020831;
sm_set_encryption_key_size_range = 0x0002083d;
sscanf_bd_addr = 0x00020b99;
sysSetPublicDeviceAddr = 0x00020f4d;
uuid128_to_str = 0x0002152d;
uuid_add_bluetooth_prefix = 0x00021585;
uuid_has_bluetooth_prefix = 0x000215a5;
uxListRemove = 0x000215c1;
uxQueueMessagesWaiting = 0x000215e9;
uxQueueMessagesWaitingFromISR = 0x00021611;
uxQueueSpacesAvailable = 0x0002162d;
uxTaskGetStackHighWaterMark = 0x00021659;
uxTaskPriorityGet = 0x00021679;
uxTaskPriorityGetFromISR = 0x00021695;
vListInitialise = 0x0002174f;
vListInitialiseItem = 0x00021765;
vListInsert = 0x0002176b;
vListInsertEnd = 0x0002179b;
vPortEndScheduler = 0x000217b5;
vPortEnterCritical = 0x000217e1;
vPortExitCritical = 0x00021825;
vPortFree = 0x00021859;
vPortSuppressTicksAndSleep = 0x000218ed;
vPortValidateInterruptPriority = 0x00021a09;
vQueueDelete = 0x00021a65;
vQueueWaitForMessageRestricted = 0x00021a91;
vTaskDelay = 0x00021ad9;
vTaskInternalSetTimeOutState = 0x00021b25;
vTaskMissedYield = 0x00021b35;
vTaskPlaceOnEventList = 0x00021b41;
vTaskPlaceOnEventListRestricted = 0x00021b79;
vTaskPriorityDisinheritAfterTimeout = 0x00021bb9;
vTaskPrioritySet = 0x00021c65;
vTaskResume = 0x00021d2d;
vTaskStartScheduler = 0x00021db1;
vTaskStepTick = 0x00021e41;
vTaskSuspend = 0x00021e71;
vTaskSuspendAll = 0x00021f2d;
vTaskSwitchContext = 0x00021f3d;
xPortStartScheduler = 0x00021fe5;
xQueueAddToSet = 0x000220ad;
xQueueCreateCountingSemaphore = 0x000220d1;
xQueueCreateCountingSemaphoreStatic = 0x0002210d;
xQueueCreateMutex = 0x00022151;
xQueueCreateMutexStatic = 0x00022167;
xQueueCreateSet = 0x00022181;
xQueueGenericCreate = 0x00022189;
xQueueGenericCreateStatic = 0x000221d5;
xQueueGenericReset = 0x0002223d;
xQueueGenericSend = 0x000222c9;
xQueueGenericSendFromISR = 0x00022435;
xQueueGiveFromISR = 0x000224f5;
xQueueGiveMutexRecursive = 0x00022599;
xQueueIsQueueEmptyFromISR = 0x000225d9;
xQueueIsQueueFullFromISR = 0x000225fd;
xQueuePeek = 0x00022625;
xQueuePeekFromISR = 0x0002274d;
xQueueReceive = 0x000227b9;
xQueueReceiveFromISR = 0x000228e5;
xQueueRemoveFromSet = 0x00022979;
xQueueSelectFromSet = 0x0002299b;
xQueueSelectFromSetFromISR = 0x000229ad;
xQueueSemaphoreTake = 0x000229c1;
xQueueTakeMutexRecursive = 0x00022b2d;
xTaskCheckForTimeOut = 0x00022b71;
xTaskCreate = 0x00022be1;
xTaskCreateStatic = 0x00022c3d;
xTaskGetCurrentTaskHandle = 0x00022cad;
xTaskGetSchedulerState = 0x00022cb9;
xTaskGetTickCount = 0x00022cd5;
xTaskGetTickCountFromISR = 0x00022ce1;
xTaskIncrementTick = 0x00022cf1;
xTaskPriorityDisinherit = 0x00022dbd;
xTaskPriorityInherit = 0x00022e51;
xTaskRemoveFromEventList = 0x00022ee5;
xTaskResumeAll = 0x00022f65;
xTaskResumeFromISR = 0x0002302d;
xTimerCreate = 0x000230b9;
xTimerCreateStatic = 0x000230ed;
xTimerCreateTimerTask = 0x00023125;
xTimerGenericCommand = 0x00023191;
xTimerGetExpiryTime = 0x00023201;
xTimerGetTimerDaemonTaskHandle = 0x00023221;
