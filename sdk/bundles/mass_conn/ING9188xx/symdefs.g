...
ll_set_adv_access_address = 0x0000d299;
ll_set_adv_coded_scheme = 0x0000d2a5;
ll_set_conn_coded_scheme = 0x0000d2d5;
ll_set_conn_latency = 0x0000d301;
ll_set_conn_tx_power = 0x0000d331;
ll_set_def_antenna = 0x0000d379;
ll_set_initiating_coded_scheme = 0x0000d395;
ll_set_max_conn_number = 0x0000d3a1;
nibble_for_char = 0x0001e225;
platform_32k_rc_auto_tune = 0x0001e2d1;
platform_32k_rc_tune = 0x0001e34d;
platform_calibrate_32k = 0x0001e361;
platform_config = 0x0001e365;
platform_enable_irq = 0x0001e48d;
platform_get_current_task = 0x0001e4c5;
platform_get_gen_os_driver = 0x0001e4e9;
platform_get_heap_status = 0x0001e4f1;
platform_get_task_handle = 0x0001e509;
...
platform_install_task_stack = 0x0001e549;
...
printf_hexdump = 0x0001e889;
pvPortMalloc = 0x0001f379;
pvTaskIncrementMutexHeldCount = 0x0001f461;
pvTimerGetTimerID = 0x0001f479;
pxPortInitialiseStack = 0x0001f4a5;
reverse_128 = 0x0001f685;
reverse_24 = 0x0001f68b;
reverse_48 = 0x0001f691;
reverse_56 = 0x0001f697;
reverse_64 = 0x0001f69d;
reverse_bd_addr = 0x0001f6a3;
reverse_bytes = 0x0001f6a9;
sm_add_event_handler = 0x0001f969;
sm_address_resolution_lookup = 0x0001fac1;
sm_authenticated = 0x0001fe21;
sm_authorization_decline = 0x0001fe2f;
sm_authorization_grant = 0x0001fe4f;
sm_authorization_state = 0x0001fe6f;
sm_bonding_decline = 0x0001fe89;
sm_config = 0x000202a9;
sm_config_conn = 0x000202c1;
sm_encryption_key_size = 0x00020477;
sm_just_works_confirm = 0x000209b1;
sm_le_device_key = 0x00020ced;
sm_passkey_input = 0x00020d83;
sm_private_random_address_generation_get = 0x00021131;
sm_private_random_address_generation_get_mode = 0x00021139;
sm_private_random_address_generation_set_mode = 0x00021145;
sm_private_random_address_generation_set_update_period = 0x0002116d;
sm_register_oob_data_callback = 0x000212a9;
sm_request_pairing = 0x000212b5;
sm_send_security_request = 0x00021cef;
sm_set_accepted_stk_generation_methods = 0x00021d15;
sm_set_authentication_requirements = 0x00021d21;
sm_set_encryption_key_size_range = 0x00021d2d;
sscanf_bd_addr = 0x00022089;
sysSetPublicDeviceAddr = 0x0002243d;
uuid128_to_str = 0x00022bb1;
uuid_add_bluetooth_prefix = 0x00022c09;
uuid_has_bluetooth_prefix = 0x00022c29;
uxListRemove = 0x00022c45;
uxQueueMessagesWaiting = 0x00022c6d;
uxQueueMessagesWaitingFromISR = 0x00022c95;
uxQueueSpacesAvailable = 0x00022cb1;
uxTaskGetStackHighWaterMark = 0x00022cdd;
uxTaskPriorityGet = 0x00022cfd;
uxTaskPriorityGetFromISR = 0x00022d19;
vListInitialise = 0x00022dd3;
vListInitialiseItem = 0x00022de9;
vListInsert = 0x00022def;
vListInsertEnd = 0x00022e1f;
vPortEndScheduler = 0x00022e39;
vPortEnterCritical = 0x00022e65;
vPortExitCritical = 0x00022ea9;
vPortFree = 0x00022edd;
vPortSuppressTicksAndSleep = 0x00022f71;
vPortValidateInterruptPriority = 0x0002308d;
vQueueDelete = 0x000230e9;
vQueueWaitForMessageRestricted = 0x00023115;
vTaskDelay = 0x0002315d;
vTaskInternalSetTimeOutState = 0x000231a9;
vTaskMissedYield = 0x000231b9;
vTaskPlaceOnEventList = 0x000231c5;
vTaskPlaceOnEventListRestricted = 0x000231fd;
vTaskPriorityDisinheritAfterTimeout = 0x0002323d;
vTaskPrioritySet = 0x000232e9;
vTaskResume = 0x000233b1;
vTaskStartScheduler = 0x00023435;
vTaskStepTick = 0x000234c5;
vTaskSuspend = 0x000234f5;
vTaskSuspendAll = 0x000235b1;
vTaskSwitchContext = 0x000235c1;
xPortStartScheduler = 0x00023669;
xQueueAddToSet = 0x00023731;
xQueueCreateCountingSemaphore = 0x00023755;
xQueueCreateCountingSemaphoreStatic = 0x00023791;
xQueueCreateMutex = 0x000237d5;
xQueueCreateMutexStatic = 0x000237eb;
xQueueCreateSet = 0x00023805;
xQueueGenericCreate = 0x0002380d;
xQueueGenericCreateStatic = 0x00023859;
xQueueGenericReset = 0x000238c1;
xQueueGenericSend = 0x0002394d;
xQueueGenericSendFromISR = 0x00023ab9;
xQueueGiveFromISR = 0x00023b79;
xQueueGiveMutexRecursive = 0x00023c1d;
xQueueIsQueueEmptyFromISR = 0x00023c5d;
xQueueIsQueueFullFromISR = 0x00023c81;
xQueuePeek = 0x00023ca9;
xQueuePeekFromISR = 0x00023dd1;
xQueueReceive = 0x00023e3d;
xQueueReceiveFromISR = 0x00023f69;
xQueueRemoveFromSet = 0x00023ffd;
xQueueSelectFromSet = 0x0002401f;
xQueueSelectFromSetFromISR = 0x00024031;
xQueueSemaphoreTake = 0x00024045;
xQueueTakeMutexRecursive = 0x000241b1;
xTaskCheckForTimeOut = 0x000241f5;
xTaskCreate = 0x00024265;
xTaskCreateStatic = 0x000242c1;
xTaskGetCurrentTaskHandle = 0x00024331;
xTaskGetSchedulerState = 0x0002433d;
xTaskGetTickCount = 0x00024359;
xTaskGetTickCountFromISR = 0x00024365;
xTaskIncrementTick = 0x00024375;
xTaskPriorityDisinherit = 0x00024441;
xTaskPriorityInherit = 0x000244d5;
xTaskRemoveFromEventList = 0x00024569;
xTaskResumeAll = 0x000245e9;
xTaskResumeFromISR = 0x000246b1;
xTimerCreate = 0x0002473d;
xTimerCreateStatic = 0x00024771;
xTimerCreateTimerTask = 0x000247a9;
xTimerGenericCommand = 0x00024815;
xTimerGetExpiryTime = 0x00024885;
xTimerGetTimerDaemonTaskHandle = 0x000248a5;
