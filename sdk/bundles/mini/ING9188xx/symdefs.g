...
platform_enable_irq = 0x0001e221;
platform_get_current_task = 0x0001e259;
platform_get_gen_os_driver = 0x0001e27d;
platform_get_heap_status = 0x0001e285;
platform_get_task_handle = 0x0001e29d;
platform_get_us_time = 0x0001e2bd;
platform_get_version = 0x0001e2c1;
platform_hrng = 0x0001e2c9;
platform_install_isr_stack = 0x0001e2d1;
platform_install_task_stack = 0x0001e2dd;
platform_patch_rf_init_data = 0x0001e315;
...
printf_hexdump = 0x0001e61d;
pvPortMalloc = 0x0001f105;
pvTaskIncrementMutexHeldCount = 0x0001f1ed;
pvTimerGetTimerID = 0x0001f205;
pxPortInitialiseStack = 0x0001f231;
reverse_128 = 0x0001f411;
reverse_24 = 0x0001f417;
reverse_48 = 0x0001f41d;
reverse_56 = 0x0001f423;
reverse_64 = 0x0001f429;
reverse_bd_addr = 0x0001f42f;
reverse_bytes = 0x0001f435;
sm_add_event_handler = 0x0001f6f5;
sm_address_resolution_lookup = 0x0001f84d;
sm_authenticated = 0x0001fbad;
sm_authorization_decline = 0x0001fbbb;
sm_authorization_grant = 0x0001fbdb;
sm_authorization_state = 0x0001fbfb;
sm_bonding_decline = 0x0001fc15;
sm_config = 0x00020035;
sm_config_conn = 0x0002004d;
sm_encryption_key_size = 0x00020203;
sm_just_works_confirm = 0x0002073d;
sm_le_device_key = 0x00020a79;
sm_passkey_input = 0x00020b0f;
sm_private_random_address_generation_get = 0x00020ebd;
sm_private_random_address_generation_get_mode = 0x00020ec5;
sm_private_random_address_generation_set_mode = 0x00020ed1;
sm_private_random_address_generation_set_update_period = 0x00020ef9;
sm_register_oob_data_callback = 0x00021035;
sm_request_pairing = 0x00021041;
sm_send_security_request = 0x00021a7b;
sm_set_accepted_stk_generation_methods = 0x00021aa1;
sm_set_authentication_requirements = 0x00021aad;
sm_set_encryption_key_size_range = 0x00021ab9;
sscanf_bd_addr = 0x00021e15;
sysSetPublicDeviceAddr = 0x000221c9;
uuid128_to_str = 0x0002293d;
uuid_add_bluetooth_prefix = 0x00022995;
uuid_has_bluetooth_prefix = 0x000229b5;
uxListRemove = 0x000229d1;
uxQueueMessagesWaiting = 0x000229f9;
uxQueueMessagesWaitingFromISR = 0x00022a21;
uxQueueSpacesAvailable = 0x00022a3d;
uxTaskGetStackHighWaterMark = 0x00022a69;
uxTaskPriorityGet = 0x00022a89;
uxTaskPriorityGetFromISR = 0x00022aa5;
vListInitialise = 0x00022b5f;
vListInitialiseItem = 0x00022b75;
vListInsert = 0x00022b7b;
vListInsertEnd = 0x00022bab;
vPortEndScheduler = 0x00022bc5;
vPortEnterCritical = 0x00022bf1;
vPortExitCritical = 0x00022c35;
vPortFree = 0x00022c69;
vPortSuppressTicksAndSleep = 0x00022cfd;
vPortValidateInterruptPriority = 0x00022e19;
vQueueDelete = 0x00022e75;
vQueueWaitForMessageRestricted = 0x00022ea1;
vTaskDelay = 0x00022ee9;
vTaskInternalSetTimeOutState = 0x00022f35;
vTaskMissedYield = 0x00022f45;
vTaskPlaceOnEventList = 0x00022f51;
vTaskPlaceOnEventListRestricted = 0x00022f89;
vTaskPriorityDisinheritAfterTimeout = 0x00022fc9;
vTaskPrioritySet = 0x00023075;
vTaskResume = 0x0002313d;
vTaskStartScheduler = 0x000231c1;
vTaskStepTick = 0x00023251;
vTaskSuspend = 0x00023281;
vTaskSuspendAll = 0x0002333d;
vTaskSwitchContext = 0x0002334d;
xPortStartScheduler = 0x000233f1;
xQueueAddToSet = 0x000234b9;
xQueueCreateCountingSemaphore = 0x000234dd;
xQueueCreateCountingSemaphoreStatic = 0x00023519;
xQueueCreateMutex = 0x0002355d;
xQueueCreateMutexStatic = 0x00023573;
xQueueCreateSet = 0x0002358d;
xQueueGenericCreate = 0x00023595;
xQueueGenericCreateStatic = 0x000235e1;
xQueueGenericReset = 0x00023649;
xQueueGenericSend = 0x000236d5;
xQueueGenericSendFromISR = 0x00023841;
xQueueGiveFromISR = 0x00023901;
xQueueGiveMutexRecursive = 0x000239a5;
xQueueIsQueueEmptyFromISR = 0x000239e5;
xQueueIsQueueFullFromISR = 0x00023a09;
xQueuePeek = 0x00023a31;
xQueuePeekFromISR = 0x00023b59;
xQueueReceive = 0x00023bc5;
xQueueReceiveFromISR = 0x00023cf1;
xQueueRemoveFromSet = 0x00023d85;
xQueueSelectFromSet = 0x00023da7;
xQueueSelectFromSetFromISR = 0x00023db9;
xQueueSemaphoreTake = 0x00023dcd;
xQueueTakeMutexRecursive = 0x00023f39;
xTaskCheckForTimeOut = 0x00023f7d;
xTaskCreate = 0x00023fed;
xTaskCreateStatic = 0x00024049;
xTaskGetCurrentTaskHandle = 0x000240b9;
xTaskGetSchedulerState = 0x000240c5;
xTaskGetTickCount = 0x000240e1;
xTaskGetTickCountFromISR = 0x000240ed;
xTaskIncrementTick = 0x000240fd;
xTaskPriorityDisinherit = 0x000241c9;
xTaskPriorityInherit = 0x0002425d;
xTaskRemoveFromEventList = 0x000242f1;
xTaskResumeAll = 0x00024371;
xTaskResumeFromISR = 0x00024439;
xTimerCreate = 0x000244c5;
xTimerCreateStatic = 0x000244f9;
xTimerCreateTimerTask = 0x00024531;
xTimerGenericCommand = 0x0002459d;
xTimerGetExpiryTime = 0x0002460d;
xTimerGetTimerDaemonTaskHandle = 0x0002462d;
