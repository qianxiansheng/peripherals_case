...
platform_enable_irq = 0x0001cf59;
platform_get_current_task = 0x0001cf91;
platform_get_gen_os_driver = 0x0001cfb5;
platform_get_heap_status = 0x0001cfbd;
platform_get_task_handle = 0x0001cfd5;
...
platform_install_task_stack = 0x0001d015;
platform_patch_rf_init_data = 0x0001d04d;
platform_printf = 0x0001d059;
platform_raise_assertion = 0x0001d06d;
platform_rand = 0x0001d081;
platform_read_info = 0x0001d085;
platform_read_persistent_reg = 0x0001d0b5;
platform_reset = 0x0001d0c5;
platform_set_evt_callback = 0x0001d0e9;
platform_set_evt_callback_table = 0x0001d0fd;
platform_set_irq_callback = 0x0001d109;
platform_set_irq_callback_table = 0x0001d125;
platform_set_rf_clk_source = 0x0001d131;
platform_set_rf_init_data = 0x0001d13d;
platform_set_rf_power_mapping = 0x0001d149;
platform_set_timer = 0x0001d155;
platform_shutdown = 0x0001d159;
platform_switch_app = 0x0001d15d;
platform_trace_raw = 0x0001d189;
platform_write_persistent_reg = 0x0001d1a1;
printf_hexdump = 0x0001d355;
pvPortMalloc = 0x0001de3d;
pvTaskIncrementMutexHeldCount = 0x0001df25;
pvTimerGetTimerID = 0x0001df3d;
pxPortInitialiseStack = 0x0001df69;
reverse_128 = 0x0001e111;
reverse_24 = 0x0001e117;
reverse_48 = 0x0001e11d;
reverse_56 = 0x0001e123;
reverse_64 = 0x0001e129;
reverse_bd_addr = 0x0001e12f;
reverse_bytes = 0x0001e135;
sm_add_event_handler = 0x0001e2a1;
sm_address_resolution_lookup = 0x0001e3f9;
sm_authenticated = 0x0001e759;
sm_authorization_decline = 0x0001e767;
sm_authorization_grant = 0x0001e787;
sm_authorization_state = 0x0001e7a7;
sm_bonding_decline = 0x0001e7c1;
sm_config = 0x0001ebe1;
sm_config_conn = 0x0001ebf9;
sm_encryption_key_size = 0x0001edaf;
sm_just_works_confirm = 0x0001f2e9;
sm_le_device_key = 0x0001f625;
sm_passkey_input = 0x0001f6bb;
...
sm_send_security_request = 0x00020627;
sm_set_accepted_stk_generation_methods = 0x0002064d;
sm_set_authentication_requirements = 0x00020659;
sm_set_encryption_key_size_range = 0x00020665;
sscanf_bd_addr = 0x000209c1;
sysSetPublicDeviceAddr = 0x00020d75;
uuid128_to_str = 0x00021355;
uuid_add_bluetooth_prefix = 0x000213ad;
uuid_has_bluetooth_prefix = 0x000213cd;
uxListRemove = 0x000213e9;
uxQueueMessagesWaiting = 0x00021411;
uxQueueMessagesWaitingFromISR = 0x00021439;
uxQueueSpacesAvailable = 0x00021455;
uxTaskGetStackHighWaterMark = 0x00021481;
uxTaskPriorityGet = 0x000214a1;
uxTaskPriorityGetFromISR = 0x000214bd;
vListInitialise = 0x00021577;
vListInitialiseItem = 0x0002158d;
vListInsert = 0x00021593;
vListInsertEnd = 0x000215c3;
vPortEndScheduler = 0x000215dd;
vPortEnterCritical = 0x00021609;
vPortExitCritical = 0x0002164d;
vPortFree = 0x00021681;
vPortSuppressTicksAndSleep = 0x00021715;
vPortValidateInterruptPriority = 0x00021831;
vQueueDelete = 0x0002188d;
vQueueWaitForMessageRestricted = 0x000218b9;
vTaskDelay = 0x00021901;
vTaskInternalSetTimeOutState = 0x0002194d;
vTaskMissedYield = 0x0002195d;
vTaskPlaceOnEventList = 0x00021969;
vTaskPlaceOnEventListRestricted = 0x000219a1;
vTaskPriorityDisinheritAfterTimeout = 0x000219e1;
vTaskPrioritySet = 0x00021a8d;
vTaskResume = 0x00021b55;
vTaskStartScheduler = 0x00021bd9;
vTaskStepTick = 0x00021c69;
vTaskSuspend = 0x00021c99;
vTaskSuspendAll = 0x00021d55;
vTaskSwitchContext = 0x00021d65;
xPortStartScheduler = 0x00021e09;
xQueueAddToSet = 0x00021ed1;
xQueueCreateCountingSemaphore = 0x00021ef5;
xQueueCreateCountingSemaphoreStatic = 0x00021f31;
xQueueCreateMutex = 0x00021f75;
xQueueCreateMutexStatic = 0x00021f8b;
xQueueCreateSet = 0x00021fa5;
xQueueGenericCreate = 0x00021fad;
xQueueGenericCreateStatic = 0x00021ff9;
xQueueGenericReset = 0x00022061;
xQueueGenericSend = 0x000220ed;
xQueueGenericSendFromISR = 0x00022259;
xQueueGiveFromISR = 0x00022319;
xQueueGiveMutexRecursive = 0x000223bd;
xQueueIsQueueEmptyFromISR = 0x000223fd;
xQueueIsQueueFullFromISR = 0x00022421;
xQueuePeek = 0x00022449;
xQueuePeekFromISR = 0x00022571;
xQueueReceive = 0x000225dd;
xQueueReceiveFromISR = 0x00022709;
xQueueRemoveFromSet = 0x0002279d;
xQueueSelectFromSet = 0x000227bf;
xQueueSelectFromSetFromISR = 0x000227d1;
xQueueSemaphoreTake = 0x000227e5;
xQueueTakeMutexRecursive = 0x00022951;
xTaskCheckForTimeOut = 0x00022995;
xTaskCreate = 0x00022a05;
xTaskCreateStatic = 0x00022a61;
xTaskGetCurrentTaskHandle = 0x00022ad1;
xTaskGetSchedulerState = 0x00022add;
xTaskGetTickCount = 0x00022af9;
xTaskGetTickCountFromISR = 0x00022b05;
xTaskIncrementTick = 0x00022b15;
xTaskPriorityDisinherit = 0x00022be1;
xTaskPriorityInherit = 0x00022c75;
xTaskRemoveFromEventList = 0x00022d09;
xTaskResumeAll = 0x00022d89;
xTaskResumeFromISR = 0x00022e51;
xTimerCreate = 0x00022edd;
xTimerCreateStatic = 0x00022f11;
xTimerCreateTimerTask = 0x00022f49;
xTimerGenericCommand = 0x00022fb5;
xTimerGetExpiryTime = 0x00023025;
xTimerGetTimerDaemonTaskHandle = 0x00023045;
