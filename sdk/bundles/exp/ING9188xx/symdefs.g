...
platform_enable_irq = 0x00020cc5;
platform_get_current_task = 0x00020cfd;
platform_get_gen_os_driver = 0x00020d21;
platform_get_heap_status = 0x00020d29;
platform_get_task_handle = 0x00020d41;
platform_get_us_time = 0x00020d61;
platform_get_version = 0x00020d65;
platform_hrng = 0x00020d6d;
platform_install_isr_stack = 0x00020d75;
platform_install_task_stack = 0x00020d81;
platform_patch_rf_init_data = 0x00020db9;
platform_printf = 0x00020dc5;
platform_raise_assertion = 0x00020dd9;
platform_rand = 0x00020ded;
platform_read_info = 0x00020df1;
platform_read_persistent_reg = 0x00020e21;
platform_reset = 0x00020e31;
platform_set_evt_callback = 0x00020e55;
platform_set_evt_callback_table = 0x00020e69;
platform_set_irq_callback = 0x00020e75;
platform_set_irq_callback_table = 0x00020e91;
platform_set_rf_clk_source = 0x00020e9d;
platform_set_rf_init_data = 0x00020ea9;
platform_set_rf_power_mapping = 0x00020eb5;
platform_set_timer = 0x00020ec1;
platform_shutdown = 0x00020ec5;
platform_switch_app = 0x00020ec9;
platform_trace_raw = 0x00020ef5;
platform_write_persistent_reg = 0x00020f0d;
printf_hexdump = 0x000210c1;
pvPortMalloc = 0x00021bb1;
pvTaskIncrementMutexHeldCount = 0x00021c99;
pvTimerGetTimerID = 0x00021cb1;
pxPortInitialiseStack = 0x00021cdd;
reverse_128 = 0x00021ebd;
reverse_24 = 0x00021ec3;
reverse_48 = 0x00021ec9;
reverse_56 = 0x00021ecf;
reverse_64 = 0x00021ed5;
reverse_bd_addr = 0x00021edb;
reverse_bytes = 0x00021ee1;
sm_add_event_handler = 0x000221e1;
sm_address_resolution_lookup = 0x00022339;
sm_authenticated = 0x00022699;
sm_authorization_decline = 0x000226a7;
sm_authorization_grant = 0x000226c7;
sm_authorization_state = 0x000226e7;
sm_bonding_decline = 0x00022701;
sm_config = 0x00022b21;
sm_config_conn = 0x00022b39;
sm_encryption_key_size = 0x00022cef;
sm_just_works_confirm = 0x00023229;
sm_le_device_key = 0x00023565;
sm_passkey_input = 0x000235fb;
sm_private_random_address_generation_get = 0x000239a9;
sm_private_random_address_generation_get_mode = 0x000239b1;
sm_private_random_address_generation_set_mode = 0x000239bd;
sm_private_random_address_generation_set_update_period = 0x000239e5;
sm_register_oob_data_callback = 0x00023b21;
sm_request_pairing = 0x00023b2d;
sm_send_security_request = 0x00024567;
sm_set_accepted_stk_generation_methods = 0x0002458d;
sm_set_authentication_requirements = 0x00024599;
sm_set_encryption_key_size_range = 0x000245a5;
sscanf_bd_addr = 0x00024975;
sysSetPublicDeviceAddr = 0x00024d29;
uuid128_to_str = 0x000254c5;
uuid_add_bluetooth_prefix = 0x0002551d;
uuid_has_bluetooth_prefix = 0x0002553d;
uxListRemove = 0x00025559;
uxQueueMessagesWaiting = 0x00025581;
uxQueueMessagesWaitingFromISR = 0x000255a9;
uxQueueSpacesAvailable = 0x000255c5;
uxTaskGetStackHighWaterMark = 0x000255f1;
uxTaskPriorityGet = 0x00025611;
uxTaskPriorityGetFromISR = 0x0002562d;
vListInitialise = 0x000256e7;
vListInitialiseItem = 0x000256fd;
vListInsert = 0x00025703;
vListInsertEnd = 0x00025733;
vPortEndScheduler = 0x0002574d;
vPortEnterCritical = 0x00025779;
vPortExitCritical = 0x000257bd;
vPortFree = 0x000257f1;
vPortSuppressTicksAndSleep = 0x00025885;
vPortValidateInterruptPriority = 0x000259a1;
vQueueDelete = 0x000259fd;
vQueueWaitForMessageRestricted = 0x00025a29;
vTaskDelay = 0x00025a71;
vTaskInternalSetTimeOutState = 0x00025abd;
vTaskMissedYield = 0x00025acd;
vTaskPlaceOnEventList = 0x00025ad9;
vTaskPlaceOnEventListRestricted = 0x00025b11;
vTaskPriorityDisinheritAfterTimeout = 0x00025b51;
vTaskPrioritySet = 0x00025bfd;
vTaskResume = 0x00025cc5;
vTaskStartScheduler = 0x00025d49;
vTaskStepTick = 0x00025dd9;
vTaskSuspend = 0x00025e09;
vTaskSuspendAll = 0x00025ec5;
vTaskSwitchContext = 0x00025ed5;
xPortStartScheduler = 0x00025f7d;
xQueueAddToSet = 0x00026045;
xQueueCreateCountingSemaphore = 0x00026069;
xQueueCreateCountingSemaphoreStatic = 0x000260a5;
xQueueCreateMutex = 0x000260e9;
xQueueCreateMutexStatic = 0x000260ff;
xQueueCreateSet = 0x00026119;
xQueueGenericCreate = 0x00026121;
xQueueGenericCreateStatic = 0x0002616d;
xQueueGenericReset = 0x000261d5;
xQueueGenericSend = 0x00026261;
xQueueGenericSendFromISR = 0x000263cd;
xQueueGiveFromISR = 0x0002648d;
xQueueGiveMutexRecursive = 0x00026531;
xQueueIsQueueEmptyFromISR = 0x00026571;
xQueueIsQueueFullFromISR = 0x00026595;
xQueuePeek = 0x000265bd;
xQueuePeekFromISR = 0x000266e5;
xQueueReceive = 0x00026751;
xQueueReceiveFromISR = 0x0002687d;
xQueueRemoveFromSet = 0x00026911;
xQueueSelectFromSet = 0x00026933;
xQueueSelectFromSetFromISR = 0x00026945;
xQueueSemaphoreTake = 0x00026959;
xQueueTakeMutexRecursive = 0x00026ac5;
xTaskCheckForTimeOut = 0x00026b09;
xTaskCreate = 0x00026b79;
xTaskCreateStatic = 0x00026bd5;
xTaskGetCurrentTaskHandle = 0x00026c45;
xTaskGetSchedulerState = 0x00026c51;
xTaskGetTickCount = 0x00026c6d;
xTaskGetTickCountFromISR = 0x00026c79;
xTaskIncrementTick = 0x00026c89;
xTaskPriorityDisinherit = 0x00026d55;
xTaskPriorityInherit = 0x00026de9;
xTaskRemoveFromEventList = 0x00026e7d;
xTaskResumeAll = 0x00026efd;
xTaskResumeFromISR = 0x00026fc5;
xTimerCreate = 0x00027051;
xTimerCreateStatic = 0x00027085;
xTimerCreateTimerTask = 0x000270bd;
xTimerGenericCommand = 0x00027129;
xTimerGetExpiryTime = 0x00027199;
xTimerGetTimerDaemonTaskHandle = 0x000271b9;
