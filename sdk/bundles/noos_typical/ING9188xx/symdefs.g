...
platform_controller_run = 0x0001e271;
platform_enable_irq = 0x0001e2a9;
platform_get_gen_os_driver = 0x0001e2e1;
platform_get_task_handle = 0x0001e2ed;
platform_get_us_time = 0x0001e305;
platform_get_version = 0x0001e309;
platform_hrng = 0x0001e311;
platform_init_controller = 0x0001e319;
platform_os_idle_resumed_hook = 0x0001e335;
platform_patch_rf_init_data = 0x0001e339;
platform_post_sleep_processing = 0x0001e345;
platform_pre_sleep_processing = 0x0001e34b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001e351;
platform_printf = 0x0001e355;
platform_raise_assertion = 0x0001e369;
platform_rand = 0x0001e37d;
platform_read_info = 0x0001e381;
platform_read_persistent_reg = 0x0001e3b1;
platform_reset = 0x0001e3c1;
platform_set_evt_callback = 0x0001e3e5;
platform_set_evt_callback_table = 0x0001e3f9;
platform_set_irq_callback = 0x0001e405;
platform_set_irq_callback_table = 0x0001e421;
...
reverse_128 = 0x0001e821;
reverse_24 = 0x0001e827;
reverse_48 = 0x0001e82d;
reverse_56 = 0x0001e833;
reverse_64 = 0x0001e839;
reverse_bd_addr = 0x0001e83f;
reverse_bytes = 0x0001e845;
sm_add_event_handler = 0x0001eb05;
sm_address_resolution_lookup = 0x0001ec5d;
...
sm_just_works_confirm = 0x0001fb4d;
sm_le_device_key = 0x0001fe89;
sm_passkey_input = 0x0001ff1f;
sm_private_random_address_generation_get = 0x000202cd;
sm_private_random_address_generation_get_mode = 0x000202d5;
sm_private_random_address_generation_set_mode = 0x000202e1;
sm_private_random_address_generation_set_update_period = 0x00020309;
sm_register_oob_data_callback = 0x00020445;
sm_request_pairing = 0x00020451;
sm_send_security_request = 0x00020e8b;
sm_set_accepted_stk_generation_methods = 0x00020eb1;
sm_set_authentication_requirements = 0x00020ebd;
sm_set_encryption_key_size_range = 0x00020ec9;
sscanf_bd_addr = 0x00021225;
sysSetPublicDeviceAddr = 0x000215d9;
uuid128_to_str = 0x00021d51;
uuid_add_bluetooth_prefix = 0x00021da9;
uuid_has_bluetooth_prefix = 0x00021dc9;
