...
--define_symbol ll_dhkey_generated=0x0000d3f5
--define_symbol ll_free=0x0000d425
--define_symbol ll_get_conn_events_info=0x0000d431
--define_symbol ll_get_conn_info=0x0000d50d
--define_symbol ll_hint_on_ce_len=0x0000d54d
--define_symbol ll_install_ecc_engine=0x0000d585
--define_symbol ll_legacy_adv_set_interval=0x0000d591
--define_symbol ll_lock_frequency=0x0000d5a1
--define_symbol ll_malloc=0x0000d5f9
--define_symbol ll_p256_key_pair_generated=0x0000d601
--define_symbol ll_raw_packet_alloc=0x0000d7b1
--define_symbol ll_raw_packet_free=0x0000d885
--define_symbol ll_raw_packet_get_bare_rx_data=0x0000d8af
--define_symbol ll_raw_packet_get_iq_samples=0x0000d975
...
--define_symbol ll_raw_packet_set_fake_cte_info=0x0000dd99
--define_symbol ll_raw_packet_set_param=0x0000ddbb
--define_symbol ll_raw_packet_set_rx_cte=0x0000de19
--define_symbol ll_raw_packet_set_tx_cte=0x0000deaf
--define_symbol ll_raw_packet_set_tx_data=0x0000deed
--define_symbol ll_scan_set_fixed_channel=0x0000dfa9
--define_symbol ll_scanner_enable_iq_sampling=0x0000dfb5
--define_symbol ll_set_adv_access_address=0x0000e165
--define_symbol ll_set_adv_coded_scheme=0x0000e171
--define_symbol ll_set_conn_coded_scheme=0x0000e1a1
--define_symbol ll_set_conn_interval_unit=0x0000e1cd
--define_symbol ll_set_conn_latency=0x0000e1d9
--define_symbol ll_set_conn_tx_power=0x0000e209
--define_symbol ll_set_def_antenna=0x0000e245
--define_symbol ll_set_initiating_coded_scheme=0x0000e261
--define_symbol ll_set_max_conn_number=0x0000e26d
--define_symbol ll_set_tx_power_range=0x0000e309
--define_symbol ll_unlock_frequency=0x0000e331
--define_symbol nibble_for_char=0x000208e1
--define_symbol platform_32k_rc_auto_tune=0x0002097d
--define_symbol platform_32k_rc_tune=0x000209f9
--define_symbol platform_calibrate_32k=0x00020a0d
--define_symbol platform_config=0x00020a11
--define_symbol platform_controller_run=0x00020b35
--define_symbol platform_enable_irq=0x00020b6d
--define_symbol platform_get_gen_os_driver=0x00020ba5
--define_symbol platform_get_task_handle=0x00020bb1
--define_symbol platform_get_us_time=0x00020bc9
--define_symbol platform_get_version=0x00020bcd
--define_symbol platform_hrng=0x00020bd5
--define_symbol platform_init_controller=0x00020bdd
--define_symbol platform_os_idle_resumed_hook=0x00020bf9
--define_symbol platform_patch_rf_init_data=0x00020bfd
--define_symbol platform_post_sleep_processing=0x00020c09
--define_symbol platform_pre_sleep_processing=0x00020c0f
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x00020c15
--define_symbol platform_printf=0x00020c19
--define_symbol platform_raise_assertion=0x00020c2d
--define_symbol platform_rand=0x00020c41
--define_symbol platform_read_info=0x00020c45
--define_symbol platform_read_persistent_reg=0x00020c75
--define_symbol platform_reset=0x00020c85
--define_symbol platform_set_evt_callback=0x00020ca9
--define_symbol platform_set_evt_callback_table=0x00020cbd
--define_symbol platform_set_irq_callback=0x00020cc9
--define_symbol platform_set_irq_callback_table=0x00020ce5
--define_symbol platform_set_rf_clk_source=0x00020cf1
--define_symbol platform_set_rf_init_data=0x00020cfd
--define_symbol platform_set_rf_power_mapping=0x00020d09
--define_symbol platform_set_timer=0x00020d15
--define_symbol platform_shutdown=0x00020d19
--define_symbol platform_switch_app=0x00020d1d
--define_symbol platform_trace_raw=0x00020d49
--define_symbol platform_write_persistent_reg=0x00020d61
--define_symbol printf_hexdump=0x00020d71
--define_symbol reverse_128=0x000210e5
--define_symbol reverse_24=0x000210eb
--define_symbol reverse_48=0x000210f1
--define_symbol reverse_56=0x000210f7
--define_symbol reverse_64=0x000210fd
--define_symbol reverse_bd_addr=0x00021103
--define_symbol reverse_bytes=0x00021109
--define_symbol sm_add_event_handler=0x00021409
--define_symbol sm_address_resolution_lookup=0x00021561
--define_symbol sm_authenticated=0x000218c1
--define_symbol sm_authorization_decline=0x000218cf
--define_symbol sm_authorization_grant=0x000218ef
--define_symbol sm_authorization_state=0x0002190f
--define_symbol sm_bonding_decline=0x00021929
--define_symbol sm_config=0x00021d49
--define_symbol sm_config_conn=0x00021d61
--define_symbol sm_encryption_key_size=0x00021f17
--define_symbol sm_just_works_confirm=0x00022451
--define_symbol sm_le_device_key=0x0002278d
--define_symbol sm_passkey_input=0x00022823
--define_symbol sm_private_random_address_generation_get=0x00022bd1
--define_symbol sm_private_random_address_generation_get_mode=0x00022bd9
--define_symbol sm_private_random_address_generation_set_mode=0x00022be5
--define_symbol sm_private_random_address_generation_set_update_period=0x00022c0d
--define_symbol sm_register_oob_data_callback=0x00022d49
--define_symbol sm_request_pairing=0x00022d55
--define_symbol sm_send_security_request=0x0002378f
--define_symbol sm_set_accepted_stk_generation_methods=0x000237b5
--define_symbol sm_set_authentication_requirements=0x000237c1
--define_symbol sm_set_encryption_key_size_range=0x000237cd
--define_symbol sscanf_bd_addr=0x00023b9d
--define_symbol sysSetPublicDeviceAddr=0x00023f51
--define_symbol uuid128_to_str=0x000246f1
--define_symbol uuid_add_bluetooth_prefix=0x00024749
--define_symbol uuid_has_bluetooth_prefix=0x00024769
