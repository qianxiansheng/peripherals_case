...
platform_controller_run = 0x0001f165;
platform_enable_irq = 0x0001f19d;
...
platform_set_evt_callback_table = 0x0001f2ed;
platform_set_irq_callback = 0x0001f2f9;
platform_set_irq_callback_table = 0x0001f315;
platform_set_rf_clk_source = 0x0001f321;
platform_set_rf_init_data = 0x0001f32d;
platform_set_rf_power_mapping = 0x0001f339;
platform_set_timer = 0x0001f345;
platform_shutdown = 0x0001f349;
platform_switch_app = 0x0001f34d;
platform_trace_raw = 0x0001f379;
platform_write_persistent_reg = 0x0001f391;
printf_hexdump = 0x0001f3a1;
reverse_128 = 0x0001f715;
reverse_24 = 0x0001f71b;
reverse_48 = 0x0001f721;
reverse_56 = 0x0001f727;
reverse_64 = 0x0001f72d;
reverse_bd_addr = 0x0001f733;
reverse_bytes = 0x0001f739;
sm_add_event_handler = 0x0001fa19;
sm_address_resolution_lookup = 0x0001fb71;
...
sm_config = 0x00020359;
sm_config_conn = 0x00020371;
sm_encryption_key_size = 0x00020527;
sm_just_works_confirm = 0x00020a61;
sm_le_device_key = 0x00020d9d;
sm_passkey_input = 0x00020e33;
sm_private_random_address_generation_get = 0x000211e1;
sm_private_random_address_generation_get_mode = 0x000211e9;
sm_private_random_address_generation_set_mode = 0x000211f5;
sm_private_random_address_generation_set_update_period = 0x0002121d;
sm_register_oob_data_callback = 0x00021359;
sm_request_pairing = 0x00021365;
sm_send_security_request = 0x00021d9f;
sm_set_accepted_stk_generation_methods = 0x00021dc5;
sm_set_authentication_requirements = 0x00021dd1;
sm_set_encryption_key_size_range = 0x00021ddd;
sscanf_bd_addr = 0x000221ad;
sysSetPublicDeviceAddr = 0x00022561;
uuid128_to_str = 0x00022cd9;
uuid_add_bluetooth_prefix = 0x00022d31;
uuid_has_bluetooth_prefix = 0x00022d51;
