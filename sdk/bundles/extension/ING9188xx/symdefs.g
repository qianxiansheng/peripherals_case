...
platform_enable_irq = 0x0001f2f1;
platform_get_current_task = 0x0001f329;
platform_get_gen_os_driver = 0x0001f34d;
platform_get_heap_status = 0x0001f355;
platform_get_task_handle = 0x0001f36d;
platform_get_us_time = 0x0001f38d;
platform_get_version = 0x0001f391;
platform_hrng = 0x0001f399;
platform_install_isr_stack = 0x0001f3a1;
platform_install_task_stack = 0x0001f3ad;
platform_patch_rf_init_data = 0x0001f3e5;
platform_printf = 0x0001f3f1;
platform_raise_assertion = 0x0001f405;
platform_rand = 0x0001f419;
platform_read_info = 0x0001f41d;
platform_read_persistent_reg = 0x0001f44d;
platform_reset = 0x0001f45d;
platform_set_evt_callback = 0x0001f481;
platform_set_evt_callback_table = 0x0001f495;
platform_set_irq_callback = 0x0001f4a1;
platform_set_irq_callback_table = 0x0001f4bd;
platform_set_rf_clk_source = 0x0001f4c9;
platform_set_rf_init_data = 0x0001f4d5;
platform_set_rf_power_mapping = 0x0001f4e1;
platform_set_timer = 0x0001f4ed;
platform_shutdown = 0x0001f4f1;
platform_switch_app = 0x0001f4f5;
platform_trace_raw = 0x0001f521;
platform_write_persistent_reg = 0x0001f539;
printf_hexdump = 0x0001f6ed;
pvPortMalloc = 0x000201dd;
pvTaskIncrementMutexHeldCount = 0x000202c5;
pvTimerGetTimerID = 0x000202dd;
pxPortInitialiseStack = 0x00020309;
reverse_128 = 0x000204e9;
reverse_24 = 0x000204ef;
reverse_48 = 0x000204f5;
reverse_56 = 0x000204fb;
reverse_64 = 0x00020501;
reverse_bd_addr = 0x00020507;
reverse_bytes = 0x0002050d;
sm_add_event_handler = 0x000207ed;
sm_address_resolution_lookup = 0x00020945;
sm_authenticated = 0x00020ca5;
sm_authorization_decline = 0x00020cb3;
sm_authorization_grant = 0x00020cd3;
sm_authorization_state = 0x00020cf3;
sm_bonding_decline = 0x00020d0d;
sm_config = 0x0002112d;
sm_config_conn = 0x00021145;
sm_encryption_key_size = 0x000212fb;
sm_just_works_confirm = 0x00021835;
sm_le_device_key = 0x00021b71;
sm_passkey_input = 0x00021c07;
sm_private_random_address_generation_get = 0x00021fb5;
sm_private_random_address_generation_get_mode = 0x00021fbd;
sm_private_random_address_generation_set_mode = 0x00021fc9;
sm_private_random_address_generation_set_update_period = 0x00021ff1;
sm_register_oob_data_callback = 0x0002212d;
sm_request_pairing = 0x00022139;
sm_send_security_request = 0x00022b73;
sm_set_accepted_stk_generation_methods = 0x00022b99;
sm_set_authentication_requirements = 0x00022ba5;
sm_set_encryption_key_size_range = 0x00022bb1;
sscanf_bd_addr = 0x00022f81;
sysSetPublicDeviceAddr = 0x00023335;
uuid128_to_str = 0x00023aa9;
uuid_add_bluetooth_prefix = 0x00023b01;
uuid_has_bluetooth_prefix = 0x00023b21;
uxListRemove = 0x00023b3d;
uxQueueMessagesWaiting = 0x00023b65;
uxQueueMessagesWaitingFromISR = 0x00023b8d;
uxQueueSpacesAvailable = 0x00023ba9;
uxTaskGetStackHighWaterMark = 0x00023bd5;
uxTaskPriorityGet = 0x00023bf5;
uxTaskPriorityGetFromISR = 0x00023c11;
vListInitialise = 0x00023ccb;
vListInitialiseItem = 0x00023ce1;
vListInsert = 0x00023ce7;
vListInsertEnd = 0x00023d17;
vPortEndScheduler = 0x00023d31;
vPortEnterCritical = 0x00023d5d;
vPortExitCritical = 0x00023da1;
vPortFree = 0x00023dd5;
vPortSuppressTicksAndSleep = 0x00023e69;
vPortValidateInterruptPriority = 0x00023f85;
vQueueDelete = 0x00023fe1;
vQueueWaitForMessageRestricted = 0x0002400d;
vTaskDelay = 0x00024055;
vTaskInternalSetTimeOutState = 0x000240a1;
vTaskMissedYield = 0x000240b1;
vTaskPlaceOnEventList = 0x000240bd;
vTaskPlaceOnEventListRestricted = 0x000240f5;
vTaskPriorityDisinheritAfterTimeout = 0x00024135;
vTaskPrioritySet = 0x000241e1;
vTaskResume = 0x000242a9;
vTaskStartScheduler = 0x0002432d;
vTaskStepTick = 0x000243bd;
vTaskSuspend = 0x000243ed;
vTaskSuspendAll = 0x000244a9;
vTaskSwitchContext = 0x000244b9;
xPortStartScheduler = 0x00024561;
xQueueAddToSet = 0x00024629;
xQueueCreateCountingSemaphore = 0x0002464d;
xQueueCreateCountingSemaphoreStatic = 0x00024689;
xQueueCreateMutex = 0x000246cd;
xQueueCreateMutexStatic = 0x000246e3;
xQueueCreateSet = 0x000246fd;
xQueueGenericCreate = 0x00024705;
xQueueGenericCreateStatic = 0x00024751;
xQueueGenericReset = 0x000247b9;
xQueueGenericSend = 0x00024845;
xQueueGenericSendFromISR = 0x000249b1;
xQueueGiveFromISR = 0x00024a71;
xQueueGiveMutexRecursive = 0x00024b15;
xQueueIsQueueEmptyFromISR = 0x00024b55;
xQueueIsQueueFullFromISR = 0x00024b79;
xQueuePeek = 0x00024ba1;
xQueuePeekFromISR = 0x00024cc9;
xQueueReceive = 0x00024d35;
xQueueReceiveFromISR = 0x00024e61;
xQueueRemoveFromSet = 0x00024ef5;
xQueueSelectFromSet = 0x00024f17;
xQueueSelectFromSetFromISR = 0x00024f29;
xQueueSemaphoreTake = 0x00024f3d;
xQueueTakeMutexRecursive = 0x000250a9;
xTaskCheckForTimeOut = 0x000250ed;
xTaskCreate = 0x0002515d;
xTaskCreateStatic = 0x000251b9;
xTaskGetCurrentTaskHandle = 0x00025229;
xTaskGetSchedulerState = 0x00025235;
xTaskGetTickCount = 0x00025251;
xTaskGetTickCountFromISR = 0x0002525d;
xTaskIncrementTick = 0x0002526d;
xTaskPriorityDisinherit = 0x00025339;
xTaskPriorityInherit = 0x000253cd;
xTaskRemoveFromEventList = 0x00025461;
xTaskResumeAll = 0x000254e1;
xTaskResumeFromISR = 0x000255a9;
xTimerCreate = 0x00025635;
xTimerCreateStatic = 0x00025669;
xTimerCreateTimerTask = 0x000256a1;
xTimerGenericCommand = 0x0002570d;
xTimerGetExpiryTime = 0x0002577d;
xTimerGetTimerDaemonTaskHandle = 0x0002579d;
