...
platform_controller_run = 0x0201ea45;
platform_enable_irq = 0x0201ea7d;
platform_get_gen_os_driver = 0x0201eab1;
platform_get_task_handle = 0x0201eabd;
platform_get_us_time = 0x0201ead5;
platform_get_version = 0x0201ead9;
platform_hrng = 0x0201eae1;
platform_init_controller = 0x0201eae9;
platform_os_idle_resumed_hook = 0x0201eb05;
platform_patch_rf_init_data = 0x0201eb09;
platform_post_sleep_processing = 0x0201eb15;
platform_pre_sleep_processing = 0x0201eb1b;
platform_pre_suppress_ticks_and_sleep_processing = 0x0201eb21;
platform_printf = 0x0201eb25;
platform_raise_assertion = 0x0201eb39;
platform_rand = 0x0201eb4d;
platform_read_info = 0x0201eb51;
platform_read_persistent_reg = 0x0201eb81;
platform_reset = 0x0201eb8d;
platform_set_evt_callback = 0x0201eba1;
platform_set_evt_callback_table = 0x0201ebb5;
platform_set_irq_callback = 0x0201ebc1;
platform_set_irq_callback_table = 0x0201ebdd;
platform_set_rf_clk_source = 0x0201ebe9;
platform_set_rf_init_data = 0x0201ebf5;
platform_set_rf_power_mapping = 0x0201ec01;
platform_set_timer = 0x0201ec0d;
platform_shutdown = 0x0201ec11;
platform_switch_app = 0x0201ec15;
platform_trace_raw = 0x0201ec2d;
platform_write_persistent_reg = 0x0201ec45;
printf_hexdump = 0x0201ec59;
reverse_128 = 0x0201efcd;
reverse_24 = 0x0201efd3;
reverse_48 = 0x0201efd9;
reverse_56 = 0x0201efdf;
reverse_64 = 0x0201efe5;
reverse_bd_addr = 0x0201efeb;
reverse_bytes = 0x0201eff1;
sm_add_event_handler = 0x0201f30d;
sm_address_resolution_lookup = 0x0201f465;
sm_authenticated = 0x0201f7c5;
sm_authorization_decline = 0x0201f7d3;
sm_authorization_grant = 0x0201f7f3;
sm_authorization_state = 0x0201f813;
sm_bonding_decline = 0x0201f82d;
sm_config = 0x0201fc45;
sm_config_conn = 0x0201fc5d;
sm_encryption_key_size = 0x0201fe13;
sm_just_works_confirm = 0x0202034d;
sm_le_device_key = 0x02020689;
sm_passkey_input = 0x0202071f;
sm_private_random_address_generation_get = 0x02020acd;
sm_private_random_address_generation_get_mode = 0x02020ad5;
sm_private_random_address_generation_set_mode = 0x02020ae1;
sm_private_random_address_generation_set_update_period = 0x02020b09;
sm_register_oob_data_callback = 0x02020c45;
sm_request_pairing = 0x02020c51;
sm_send_security_request = 0x0202168f;
sm_set_accepted_stk_generation_methods = 0x020216b5;
sm_set_authentication_requirements = 0x020216c1;
sm_set_encryption_key_size_range = 0x020216cd;
sscanf_bd_addr = 0x02021a2d;
sysSetPublicDeviceAddr = 0x02021e99;
uuid128_to_str = 0x02022649;
uuid_add_bluetooth_prefix = 0x020226a1;
uuid_has_bluetooth_prefix = 0x020226c1;
