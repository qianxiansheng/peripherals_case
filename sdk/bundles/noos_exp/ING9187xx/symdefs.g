...
platform_controller_run = 0x0001f4fd;
platform_enable_irq = 0x0001f535;
platform_get_gen_os_driver = 0x0001f56d;
platform_get_task_handle = 0x0001f579;
platform_get_us_time = 0x0001f591;
platform_get_version = 0x0001f595;
platform_hrng = 0x0001f59d;
platform_init_controller = 0x0001f5a5;
platform_os_idle_resumed_hook = 0x0001f5c1;
platform_patch_rf_init_data = 0x0001f5c5;
platform_post_sleep_processing = 0x0001f5d1;
platform_pre_sleep_processing = 0x0001f5d7;
platform_pre_suppress_ticks_and_sleep_processing = 0x0001f5dd;
platform_printf = 0x0001f5e1;
platform_raise_assertion = 0x0001f5f5;
platform_rand = 0x0001f609;
platform_read_info = 0x0001f60d;
platform_read_persistent_reg = 0x0001f63d;
platform_reset = 0x0001f64d;
platform_set_evt_callback = 0x0001f671;
platform_set_evt_callback_table = 0x0001f685;
platform_set_irq_callback = 0x0001f691;
platform_set_irq_callback_table = 0x0001f6ad;
platform_set_rf_clk_source = 0x0001f6b9;
platform_set_rf_init_data = 0x0001f6c5;
platform_set_rf_power_mapping = 0x0001f6d1;
platform_set_timer = 0x0001f6dd;
platform_shutdown = 0x0001f6e1;
platform_switch_app = 0x0001f6e5;
platform_trace_raw = 0x0001f711;
platform_write_persistent_reg = 0x0001f729;
printf_hexdump = 0x0001f739;
reverse_128 = 0x0001fa75;
reverse_24 = 0x0001fa7b;
reverse_48 = 0x0001fa81;
reverse_56 = 0x0001fa87;
reverse_64 = 0x0001fa8d;
reverse_bd_addr = 0x0001fa93;
reverse_bytes = 0x0001fa99;
sm_add_event_handler = 0x0001fc45;
sm_address_resolution_lookup = 0x0001fd9d;
sm_authenticated = 0x000200fd;
sm_authorization_decline = 0x0002010b;
sm_authorization_grant = 0x0002012b;
sm_authorization_state = 0x0002014b;
sm_bonding_decline = 0x00020165;
sm_config = 0x00020585;
sm_config_conn = 0x0002059d;
sm_encryption_key_size = 0x00020753;
sm_just_works_confirm = 0x00020c8d;
sm_le_device_key = 0x00020fc9;
sm_passkey_input = 0x0002105f;
sm_private_random_address_generation_get = 0x0002140d;
sm_private_random_address_generation_get_mode = 0x00021415;
sm_private_random_address_generation_set_mode = 0x00021421;
sm_private_random_address_generation_set_update_period = 0x00021449;
sm_register_oob_data_callback = 0x00021585;
sm_request_pairing = 0x00021591;
sm_send_security_request = 0x00021fcb;
sm_set_accepted_stk_generation_methods = 0x00021ff1;
sm_set_authentication_requirements = 0x00021ffd;
sm_set_encryption_key_size_range = 0x00022009;
sscanf_bd_addr = 0x000223d9;
sysSetPublicDeviceAddr = 0x0002278d;
uuid128_to_str = 0x00022d99;
uuid_add_bluetooth_prefix = 0x00022df1;
uuid_has_bluetooth_prefix = 0x00022e11;
