...
--define_symbol ll_dhkey_generated=0x0000d541
--define_symbol ll_free=0x0000d571
--define_symbol ll_get_conn_events_info=0x0000d57d
--define_symbol ll_get_conn_info=0x0000d659
--define_symbol ll_hint_on_ce_len=0x0000d699
--define_symbol ll_install_ecc_engine=0x0000d6d1
--define_symbol ll_legacy_adv_set_interval=0x0000d6dd
--define_symbol ll_lock_frequency=0x0000d6ed
--define_symbol ll_malloc=0x0000d745
--define_symbol ll_p256_key_pair_generated=0x0000d74d
--define_symbol ll_raw_packet_alloc=0x0000d8fd
--define_symbol ll_raw_packet_free=0x0000d9d1
--define_symbol ll_raw_packet_get_bare_rx_data=0x0000d9fb
--define_symbol ll_raw_packet_get_iq_samples=0x0000dac1
...
--define_symbol ll_raw_packet_set_fake_cte_info=0x0000dee5
--define_symbol ll_raw_packet_set_param=0x0000df07
--define_symbol ll_raw_packet_set_rx_cte=0x0000df65
--define_symbol ll_raw_packet_set_tx_cte=0x0000dffb
--define_symbol ll_raw_packet_set_tx_data=0x0000e039
--define_symbol ll_scan_set_fixed_channel=0x0000e0f5
--define_symbol ll_scanner_enable_iq_sampling=0x0000e101
--define_symbol ll_set_adv_access_address=0x0000e2b1
--define_symbol ll_set_adv_coded_scheme=0x0000e2bd
--define_symbol ll_set_conn_coded_scheme=0x0000e2ed
--define_symbol ll_set_conn_interval_unit=0x0000e319
--define_symbol ll_set_conn_latency=0x0000e325
--define_symbol ll_set_conn_tx_power=0x0000e355
--define_symbol ll_set_def_antenna=0x0000e391
--define_symbol ll_set_initiating_coded_scheme=0x0000e3ad
--define_symbol ll_set_max_conn_number=0x0000e3b9
--define_symbol ll_set_tx_power_range=0x0000e455
--define_symbol ll_unlock_frequency=0x0000e47d
--define_symbol nibble_for_char=0x00020a59
--define_symbol platform_32k_rc_auto_tune=0x00020b09
--define_symbol platform_32k_rc_tune=0x00020b85
--define_symbol platform_calibrate_32k=0x00020b99
--define_symbol platform_config=0x00020b9d
--define_symbol platform_enable_irq=0x00020cc5
--define_symbol platform_get_current_task=0x00020cfd
--define_symbol platform_get_gen_os_driver=0x00020d21
--define_symbol platform_get_heap_status=0x00020d29
--define_symbol platform_get_task_handle=0x00020d41
--define_symbol platform_get_us_time=0x00020d61
--define_symbol platform_get_version=0x00020d65
--define_symbol platform_hrng=0x00020d6d
--define_symbol platform_install_isr_stack=0x00020d75
--define_symbol platform_install_task_stack=0x00020d81
--define_symbol platform_patch_rf_init_data=0x00020db9
--define_symbol platform_printf=0x00020dc5
--define_symbol platform_raise_assertion=0x00020dd9
--define_symbol platform_rand=0x00020ded
--define_symbol platform_read_info=0x00020df1
--define_symbol platform_read_persistent_reg=0x00020e21
--define_symbol platform_reset=0x00020e31
--define_symbol platform_set_evt_callback=0x00020e55
--define_symbol platform_set_evt_callback_table=0x00020e69
--define_symbol platform_set_irq_callback=0x00020e75
--define_symbol platform_set_irq_callback_table=0x00020e91
--define_symbol platform_set_rf_clk_source=0x00020e9d
--define_symbol platform_set_rf_init_data=0x00020ea9
--define_symbol platform_set_rf_power_mapping=0x00020eb5
--define_symbol platform_set_timer=0x00020ec1
--define_symbol platform_shutdown=0x00020ec5
--define_symbol platform_switch_app=0x00020ec9
--define_symbol platform_trace_raw=0x00020ef5
--define_symbol platform_write_persistent_reg=0x00020f0d
--define_symbol printf_hexdump=0x000210c1
--define_symbol pvPortMalloc=0x00021bb1
--define_symbol pvTaskIncrementMutexHeldCount=0x00021c99
--define_symbol pvTimerGetTimerID=0x00021cb1
--define_symbol pxPortInitialiseStack=0x00021cdd
--define_symbol reverse_128=0x00021ebd
--define_symbol reverse_24=0x00021ec3
--define_symbol reverse_48=0x00021ec9
--define_symbol reverse_56=0x00021ecf
--define_symbol reverse_64=0x00021ed5
--define_symbol reverse_bd_addr=0x00021edb
--define_symbol reverse_bytes=0x00021ee1
--define_symbol sm_add_event_handler=0x000221e1
--define_symbol sm_address_resolution_lookup=0x00022339
--define_symbol sm_authenticated=0x00022699
--define_symbol sm_authorization_decline=0x000226a7
--define_symbol sm_authorization_grant=0x000226c7
--define_symbol sm_authorization_state=0x000226e7
--define_symbol sm_bonding_decline=0x00022701
--define_symbol sm_config=0x00022b21
--define_symbol sm_config_conn=0x00022b39
--define_symbol sm_encryption_key_size=0x00022cef
--define_symbol sm_just_works_confirm=0x00023229
--define_symbol sm_le_device_key=0x00023565
--define_symbol sm_passkey_input=0x000235fb
--define_symbol sm_private_random_address_generation_get=0x000239a9
--define_symbol sm_private_random_address_generation_get_mode=0x000239b1
--define_symbol sm_private_random_address_generation_set_mode=0x000239bd
--define_symbol sm_private_random_address_generation_set_update_period=0x000239e5
--define_symbol sm_register_oob_data_callback=0x00023b21
--define_symbol sm_request_pairing=0x00023b2d
--define_symbol sm_send_security_request=0x00024567
--define_symbol sm_set_accepted_stk_generation_methods=0x0002458d
--define_symbol sm_set_authentication_requirements=0x00024599
--define_symbol sm_set_encryption_key_size_range=0x000245a5
--define_symbol sscanf_bd_addr=0x00024975
--define_symbol sysSetPublicDeviceAddr=0x00024d29
--define_symbol uuid128_to_str=0x000254c5
--define_symbol uuid_add_bluetooth_prefix=0x0002551d
--define_symbol uuid_has_bluetooth_prefix=0x0002553d
--define_symbol uxListRemove=0x00025559
--define_symbol uxQueueMessagesWaiting=0x00025581
--define_symbol uxQueueMessagesWaitingFromISR=0x000255a9
--define_symbol uxQueueSpacesAvailable=0x000255c5
--define_symbol uxTaskGetStackHighWaterMark=0x000255f1
--define_symbol uxTaskPriorityGet=0x00025611
--define_symbol uxTaskPriorityGetFromISR=0x0002562d
--define_symbol vListInitialise=0x000256e7
--define_symbol vListInitialiseItem=0x000256fd
--define_symbol vListInsert=0x00025703
--define_symbol vListInsertEnd=0x00025733
--define_symbol vPortEndScheduler=0x0002574d
--define_symbol vPortEnterCritical=0x00025779
--define_symbol vPortExitCritical=0x000257bd
--define_symbol vPortFree=0x000257f1
--define_symbol vPortSuppressTicksAndSleep=0x00025885
--define_symbol vPortValidateInterruptPriority=0x000259a1
--define_symbol vQueueDelete=0x000259fd
--define_symbol vQueueWaitForMessageRestricted=0x00025a29
--define_symbol vTaskDelay=0x00025a71
--define_symbol vTaskInternalSetTimeOutState=0x00025abd
--define_symbol vTaskMissedYield=0x00025acd
--define_symbol vTaskPlaceOnEventList=0x00025ad9
--define_symbol vTaskPlaceOnEventListRestricted=0x00025b11
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00025b51
--define_symbol vTaskPrioritySet=0x00025bfd
--define_symbol vTaskResume=0x00025cc5
--define_symbol vTaskStartScheduler=0x00025d49
--define_symbol vTaskStepTick=0x00025dd9
--define_symbol vTaskSuspend=0x00025e09
--define_symbol vTaskSuspendAll=0x00025ec5
--define_symbol vTaskSwitchContext=0x00025ed5
--define_symbol xPortStartScheduler=0x00025f7d
--define_symbol xQueueAddToSet=0x00026045
--define_symbol xQueueCreateCountingSemaphore=0x00026069
--define_symbol xQueueCreateCountingSemaphoreStatic=0x000260a5
--define_symbol xQueueCreateMutex=0x000260e9
--define_symbol xQueueCreateMutexStatic=0x000260ff
--define_symbol xQueueCreateSet=0x00026119
--define_symbol xQueueGenericCreate=0x00026121
--define_symbol xQueueGenericCreateStatic=0x0002616d
--define_symbol xQueueGenericReset=0x000261d5
--define_symbol xQueueGenericSend=0x00026261
--define_symbol xQueueGenericSendFromISR=0x000263cd
--define_symbol xQueueGiveFromISR=0x0002648d
--define_symbol xQueueGiveMutexRecursive=0x00026531
--define_symbol xQueueIsQueueEmptyFromISR=0x00026571
--define_symbol xQueueIsQueueFullFromISR=0x00026595
--define_symbol xQueuePeek=0x000265bd
--define_symbol xQueuePeekFromISR=0x000266e5
--define_symbol xQueueReceive=0x00026751
--define_symbol xQueueReceiveFromISR=0x0002687d
--define_symbol xQueueRemoveFromSet=0x00026911
--define_symbol xQueueSelectFromSet=0x00026933
--define_symbol xQueueSelectFromSetFromISR=0x00026945
--define_symbol xQueueSemaphoreTake=0x00026959
--define_symbol xQueueTakeMutexRecursive=0x00026ac5
--define_symbol xTaskCheckForTimeOut=0x00026b09
--define_symbol xTaskCreate=0x00026b79
--define_symbol xTaskCreateStatic=0x00026bd5
--define_symbol xTaskGetCurrentTaskHandle=0x00026c45
--define_symbol xTaskGetSchedulerState=0x00026c51
--define_symbol xTaskGetTickCount=0x00026c6d
--define_symbol xTaskGetTickCountFromISR=0x00026c79
--define_symbol xTaskIncrementTick=0x00026c89
--define_symbol xTaskPriorityDisinherit=0x00026d55
--define_symbol xTaskPriorityInherit=0x00026de9
--define_symbol xTaskRemoveFromEventList=0x00026e7d
--define_symbol xTaskResumeAll=0x00026efd
--define_symbol xTaskResumeFromISR=0x00026fc5
--define_symbol xTimerCreate=0x00027051
--define_symbol xTimerCreateStatic=0x00027085
--define_symbol xTimerCreateTimerTask=0x000270bd
--define_symbol xTimerGenericCommand=0x00027129
--define_symbol xTimerGetExpiryTime=0x00027199
--define_symbol xTimerGetTimerDaemonTaskHandle=0x000271b9
