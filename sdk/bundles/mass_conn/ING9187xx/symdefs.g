...
ll_config = 0x0000cb51;
ll_free = 0x0000cb61;
ll_hint_on_ce_len = 0x0000cb6d;
ll_legacy_adv_set_interval = 0x0000cba5;
ll_malloc = 0x0000cbb5;
ll_query_timing_info = 0x0000cced;
ll_scan_set_fixed_channel = 0x0000cd91;
ll_set_adv_access_address = 0x0000cea5;
ll_set_adv_coded_scheme = 0x0000ceb1;
ll_set_conn_coded_scheme = 0x0000cee1;
ll_set_conn_latency = 0x0000cf0d;
ll_set_conn_tx_power = 0x0000cf3d;
ll_set_def_antenna = 0x0000cf85;
ll_set_initiating_coded_scheme = 0x0000cfa1;
ll_set_max_conn_number = 0x0000cfad;
nibble_for_char = 0x0001cf51;
platform_32k_rc_auto_tune = 0x0001cffd;
platform_32k_rc_tune = 0x0001d079;
platform_calibrate_32k = 0x0001d08d;
platform_config = 0x0001d091;
platform_enable_irq = 0x0001d1b9;
platform_get_current_task = 0x0001d1f1;
platform_get_gen_os_driver = 0x0001d215;
platform_get_heap_status = 0x0001d21d;
platform_get_task_handle = 0x0001d235;
platform_get_us_time = 0x0001d255;
platform_get_version = 0x0001d259;
platform_hrng = 0x0001d261;
platform_install_isr_stack = 0x0001d269;
platform_install_task_stack = 0x0001d275;
platform_patch_rf_init_data = 0x0001d2ad;
platform_printf = 0x0001d2b9;
platform_raise_assertion = 0x0001d2cd;
platform_rand = 0x0001d2e1;
platform_read_info = 0x0001d2e5;
platform_read_persistent_reg = 0x0001d315;
platform_reset = 0x0001d325;
platform_set_evt_callback = 0x0001d349;
platform_set_evt_callback_table = 0x0001d35d;
platform_set_irq_callback = 0x0001d369;
platform_set_irq_callback_table = 0x0001d385;
platform_set_rf_clk_source = 0x0001d391;
platform_set_rf_init_data = 0x0001d39d;
platform_set_rf_power_mapping = 0x0001d3a9;
platform_set_timer = 0x0001d3b5;
platform_shutdown = 0x0001d3b9;
platform_switch_app = 0x0001d3bd;
platform_trace_raw = 0x0001d3e9;
platform_write_persistent_reg = 0x0001d401;
printf_hexdump = 0x0001d5b5;
...
sm_address_resolution_lookup = 0x0001e661;
sm_authenticated = 0x0001e9c1;
sm_authorization_decline = 0x0001e9cf;
sm_authorization_grant = 0x0001e9ef;
sm_authorization_state = 0x0001ea0f;
sm_bonding_decline = 0x0001ea29;
sm_config = 0x0001ee49;
sm_config_conn = 0x0001ee61;
sm_encryption_key_size = 0x0001f017;
sm_just_works_confirm = 0x0001f551;
sm_le_device_key = 0x0001f88d;
sm_passkey_input = 0x0001f923;
sm_private_random_address_generation_get = 0x0001fcd1;
sm_private_random_address_generation_get_mode = 0x0001fcd9;
sm_private_random_address_generation_set_mode = 0x0001fce5;
sm_private_random_address_generation_set_update_period = 0x0001fd0d;
sm_register_oob_data_callback = 0x0001fe49;
sm_request_pairing = 0x0001fe55;
sm_send_security_request = 0x0002088f;
sm_set_accepted_stk_generation_methods = 0x000208b5;
sm_set_authentication_requirements = 0x000208c1;
sm_set_encryption_key_size_range = 0x000208cd;
sscanf_bd_addr = 0x00020c29;
sysSetPublicDeviceAddr = 0x00020fdd;
uuid128_to_str = 0x000215bd;
uuid_add_bluetooth_prefix = 0x00021615;
uuid_has_bluetooth_prefix = 0x00021635;
uxListRemove = 0x00021651;
uxQueueMessagesWaiting = 0x00021679;
uxQueueMessagesWaitingFromISR = 0x000216a1;
uxQueueSpacesAvailable = 0x000216bd;
uxTaskGetStackHighWaterMark = 0x000216e9;
uxTaskPriorityGet = 0x00021709;
uxTaskPriorityGetFromISR = 0x00021725;
vListInitialise = 0x000217df;
vListInitialiseItem = 0x000217f5;
vListInsert = 0x000217fb;
vListInsertEnd = 0x0002182b;
vPortEndScheduler = 0x00021845;
vPortEnterCritical = 0x00021871;
vPortExitCritical = 0x000218b5;
vPortFree = 0x000218e9;
vPortSuppressTicksAndSleep = 0x0002197d;
vPortValidateInterruptPriority = 0x00021a99;
vQueueDelete = 0x00021af5;
vQueueWaitForMessageRestricted = 0x00021b21;
vTaskDelay = 0x00021b69;
vTaskInternalSetTimeOutState = 0x00021bb5;
vTaskMissedYield = 0x00021bc5;
vTaskPlaceOnEventList = 0x00021bd1;
vTaskPlaceOnEventListRestricted = 0x00021c09;
vTaskPriorityDisinheritAfterTimeout = 0x00021c49;
vTaskPrioritySet = 0x00021cf5;
vTaskResume = 0x00021dbd;
vTaskStartScheduler = 0x00021e41;
vTaskStepTick = 0x00021ed1;
vTaskSuspend = 0x00021f01;
vTaskSuspendAll = 0x00021fbd;
vTaskSwitchContext = 0x00021fcd;
xPortStartScheduler = 0x00022075;
xQueueAddToSet = 0x0002213d;
xQueueCreateCountingSemaphore = 0x00022161;
xQueueCreateCountingSemaphoreStatic = 0x0002219d;
xQueueCreateMutex = 0x000221e1;
xQueueCreateMutexStatic = 0x000221f7;
xQueueCreateSet = 0x00022211;
xQueueGenericCreate = 0x00022219;
xQueueGenericCreateStatic = 0x00022265;
xQueueGenericReset = 0x000222cd;
xQueueGenericSend = 0x00022359;
xQueueGenericSendFromISR = 0x000224c5;
xQueueGiveFromISR = 0x00022585;
xQueueGiveMutexRecursive = 0x00022629;
xQueueIsQueueEmptyFromISR = 0x00022669;
xQueueIsQueueFullFromISR = 0x0002268d;
xQueuePeek = 0x000226b5;
xQueuePeekFromISR = 0x000227dd;
xQueueReceive = 0x00022849;
xQueueReceiveFromISR = 0x00022975;
xQueueRemoveFromSet = 0x00022a09;
xQueueSelectFromSet = 0x00022a2b;
xQueueSelectFromSetFromISR = 0x00022a3d;
xQueueSemaphoreTake = 0x00022a51;
xQueueTakeMutexRecursive = 0x00022bbd;
xTaskCheckForTimeOut = 0x00022c01;
xTaskCreate = 0x00022c71;
xTaskCreateStatic = 0x00022ccd;
xTaskGetCurrentTaskHandle = 0x00022d3d;
xTaskGetSchedulerState = 0x00022d49;
xTaskGetTickCount = 0x00022d65;
xTaskGetTickCountFromISR = 0x00022d71;
xTaskIncrementTick = 0x00022d81;
xTaskPriorityDisinherit = 0x00022e4d;
xTaskPriorityInherit = 0x00022ee1;
xTaskRemoveFromEventList = 0x00022f75;
xTaskResumeAll = 0x00022ff5;
xTaskResumeFromISR = 0x000230bd;
xTimerCreate = 0x00023149;
xTimerCreateStatic = 0x0002317d;
xTimerCreateTimerTask = 0x000231b5;
xTimerGenericCommand = 0x00023221;
xTimerGetExpiryTime = 0x00023291;
xTimerGetTimerDaemonTaskHandle = 0x000232b1;
