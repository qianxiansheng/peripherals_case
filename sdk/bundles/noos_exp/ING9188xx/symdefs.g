...
platform_controller_run = 0x00020b35;
platform_enable_irq = 0x00020b6d;
platform_get_gen_os_driver = 0x00020ba5;
platform_get_task_handle = 0x00020bb1;
platform_get_us_time = 0x00020bc9;
platform_get_version = 0x00020bcd;
platform_hrng = 0x00020bd5;
platform_init_controller = 0x00020bdd;
platform_os_idle_resumed_hook = 0x00020bf9;
platform_patch_rf_init_data = 0x00020bfd;
platform_post_sleep_processing = 0x00020c09;
platform_pre_sleep_processing = 0x00020c0f;
platform_pre_suppress_ticks_and_sleep_processing = 0x00020c15;
platform_printf = 0x00020c19;
platform_raise_assertion = 0x00020c2d;
platform_rand = 0x00020c41;
platform_read_info = 0x00020c45;
platform_read_persistent_reg = 0x00020c75;
platform_reset = 0x00020c85;
platform_set_evt_callback = 0x00020ca9;
platform_set_evt_callback_table = 0x00020cbd;
platform_set_irq_callback = 0x00020cc9;
platform_set_irq_callback_table = 0x00020ce5;
platform_set_rf_clk_source = 0x00020cf1;
platform_set_rf_init_data = 0x00020cfd;
platform_set_rf_power_mapping = 0x00020d09;
platform_set_timer = 0x00020d15;
platform_shutdown = 0x00020d19;
platform_switch_app = 0x00020d1d;
platform_trace_raw = 0x00020d49;
platform_write_persistent_reg = 0x00020d61;
printf_hexdump = 0x00020d71;
reverse_128 = 0x000210e5;
reverse_24 = 0x000210eb;
reverse_48 = 0x000210f1;
reverse_56 = 0x000210f7;
reverse_64 = 0x000210fd;
reverse_bd_addr = 0x00021103;
reverse_bytes = 0x00021109;
sm_add_event_handler = 0x00021409;
sm_address_resolution_lookup = 0x00021561;
sm_authenticated = 0x000218c1;
sm_authorization_decline = 0x000218cf;
sm_authorization_grant = 0x000218ef;
sm_authorization_state = 0x0002190f;
sm_bonding_decline = 0x00021929;
sm_config = 0x00021d49;
sm_config_conn = 0x00021d61;
sm_encryption_key_size = 0x00021f17;
sm_just_works_confirm = 0x00022451;
sm_le_device_key = 0x0002278d;
sm_passkey_input = 0x00022823;
sm_private_random_address_generation_get = 0x00022bd1;
sm_private_random_address_generation_get_mode = 0x00022bd9;
sm_private_random_address_generation_set_mode = 0x00022be5;
sm_private_random_address_generation_set_update_period = 0x00022c0d;
sm_register_oob_data_callback = 0x00022d49;
sm_request_pairing = 0x00022d55;
sm_send_security_request = 0x0002378f;
sm_set_accepted_stk_generation_methods = 0x000237b5;
sm_set_authentication_requirements = 0x000237c1;
sm_set_encryption_key_size_range = 0x000237cd;
sscanf_bd_addr = 0x00023b9d;
sysSetPublicDeviceAddr = 0x00023f51;
uuid128_to_str = 0x000246f1;
uuid_add_bluetooth_prefix = 0x00024749;
uuid_has_bluetooth_prefix = 0x00024769;
