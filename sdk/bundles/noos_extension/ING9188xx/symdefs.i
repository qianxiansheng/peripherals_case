...
--define_symbol ll_raw_packet_get_bare_rx_data=0x0000d4f3
--define_symbol ll_raw_packet_get_iq_samples=0x0000d5b9
--define_symbol ll_raw_packet_get_rx_data=0x0000d653
--define_symbol ll_raw_packet_recv=0x0000d6f5
--define_symbol ll_raw_packet_send=0x0000d7b1
--define_symbol ll_raw_packet_set_bare_data=0x0000d899
--define_symbol ll_raw_packet_set_bare_mode=0x0000d8d7
--define_symbol ll_raw_packet_set_fake_cte_info=0x0000d9dd
--define_symbol ll_raw_packet_set_param=0x0000d9ff
--define_symbol ll_raw_packet_set_rx_cte=0x0000da5d
--define_symbol ll_raw_packet_set_tx_cte=0x0000daf3
--define_symbol ll_raw_packet_set_tx_data=0x0000db31
--define_symbol ll_scan_set_fixed_channel=0x0000dbed
--define_symbol ll_scanner_enable_iq_sampling=0x0000dbf9
--define_symbol ll_set_adv_access_address=0x0000dda9
--define_symbol ll_set_adv_coded_scheme=0x0000ddb5
--define_symbol ll_set_conn_coded_scheme=0x0000dde5
--define_symbol ll_set_conn_interval_unit=0x0000de11
--define_symbol ll_set_conn_latency=0x0000de1d
--define_symbol ll_set_conn_tx_power=0x0000de4d
--define_symbol ll_set_def_antenna=0x0000de95
--define_symbol ll_set_initiating_coded_scheme=0x0000deb1
--define_symbol ll_set_max_conn_number=0x0000debd
--define_symbol ll_unlock_frequency=0x0000df59
--define_symbol nibble_for_char=0x0001ef11
--define_symbol platform_32k_rc_auto_tune=0x0001efad
--define_symbol platform_32k_rc_tune=0x0001f029
--define_symbol platform_calibrate_32k=0x0001f03d
--define_symbol platform_config=0x0001f041
--define_symbol platform_controller_run=0x0001f165
--define_symbol platform_enable_irq=0x0001f19d
--define_symbol platform_get_gen_os_driver=0x0001f1d5
--define_symbol platform_get_task_handle=0x0001f1e1
--define_symbol platform_get_us_time=0x0001f1f9
--define_symbol platform_get_version=0x0001f1fd
--define_symbol platform_hrng=0x0001f205
--define_symbol platform_init_controller=0x0001f20d
--define_symbol platform_os_idle_resumed_hook=0x0001f229
--define_symbol platform_patch_rf_init_data=0x0001f22d
--define_symbol platform_post_sleep_processing=0x0001f239
--define_symbol platform_pre_sleep_processing=0x0001f23f
--define_symbol platform_pre_suppress_ticks_and_sleep_processing=0x0001f245
--define_symbol platform_printf=0x0001f249
--define_symbol platform_raise_assertion=0x0001f25d
--define_symbol platform_rand=0x0001f271
--define_symbol platform_read_info=0x0001f275
--define_symbol platform_read_persistent_reg=0x0001f2a5
--define_symbol platform_reset=0x0001f2b5
--define_symbol platform_set_evt_callback=0x0001f2d9
--define_symbol platform_set_evt_callback_table=0x0001f2ed
--define_symbol platform_set_irq_callback=0x0001f2f9
--define_symbol platform_set_irq_callback_table=0x0001f315
--define_symbol platform_set_rf_clk_source=0x0001f321
--define_symbol platform_set_rf_init_data=0x0001f32d
--define_symbol platform_set_rf_power_mapping=0x0001f339
--define_symbol platform_set_timer=0x0001f345
--define_symbol platform_shutdown=0x0001f349
--define_symbol platform_switch_app=0x0001f34d
--define_symbol platform_trace_raw=0x0001f379
--define_symbol platform_write_persistent_reg=0x0001f391
--define_symbol printf_hexdump=0x0001f3a1
--define_symbol reverse_128=0x0001f715
--define_symbol reverse_24=0x0001f71b
--define_symbol reverse_48=0x0001f721
--define_symbol reverse_56=0x0001f727
--define_symbol reverse_64=0x0001f72d
--define_symbol reverse_bd_addr=0x0001f733
--define_symbol reverse_bytes=0x0001f739
--define_symbol sm_add_event_handler=0x0001fa19
--define_symbol sm_address_resolution_lookup=0x0001fb71
--define_symbol sm_authenticated=0x0001fed1
--define_symbol sm_authorization_decline=0x0001fedf
--define_symbol sm_authorization_grant=0x0001feff
--define_symbol sm_authorization_state=0x0001ff1f
--define_symbol sm_bonding_decline=0x0001ff39
--define_symbol sm_config=0x00020359
--define_symbol sm_config_conn=0x00020371
--define_symbol sm_encryption_key_size=0x00020527
--define_symbol sm_just_works_confirm=0x00020a61
--define_symbol sm_le_device_key=0x00020d9d
--define_symbol sm_passkey_input=0x00020e33
--define_symbol sm_private_random_address_generation_get=0x000211e1
--define_symbol sm_private_random_address_generation_get_mode=0x000211e9
--define_symbol sm_private_random_address_generation_set_mode=0x000211f5
--define_symbol sm_private_random_address_generation_set_update_period=0x0002121d
--define_symbol sm_register_oob_data_callback=0x00021359
--define_symbol sm_request_pairing=0x00021365
--define_symbol sm_send_security_request=0x00021d9f
--define_symbol sm_set_accepted_stk_generation_methods=0x00021dc5
--define_symbol sm_set_authentication_requirements=0x00021dd1
--define_symbol sm_set_encryption_key_size_range=0x00021ddd
--define_symbol sscanf_bd_addr=0x000221ad
--define_symbol sysSetPublicDeviceAddr=0x00022561
--define_symbol uuid128_to_str=0x00022cd9
--define_symbol uuid_add_bluetooth_prefix=0x00022d31
--define_symbol uuid_has_bluetooth_prefix=0x00022d51
